...
<div class="svg-figure">
<svg viewBox="0 0 1000 480" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="산 등반으로 본 학습 흐름. 챕터 2 Docker 이해하기에서 시작해 챕터 6 Kubernetes 운영하기 정상까지 다섯 캠프를 차례로 오른다.">
  <defs>
  ...
  <text x="74" y="382" font-size="14" font-weight="700" fill="#6b7280">챕터 2 · Docker</text>
  ...
  <text x="259" y="320" font-size="14" font-weight="700" fill="#6b7280">챕터 3 · Docker</text>
  ...
  <text x="444" y="257" font-size="14" font-weight="700" fill="#6b7280">챕터 4 · Kubernetes</text>
  ...
  <text x="629" y="197" font-size="14" font-weight="700" fill="#6b7280">챕터 5 · Kubernetes</text>
  ...
  <text x="814" y="122" font-size="14" font-weight="700" fill="#3730a3">챕터 6 · Kubernetes</text>
