...
*그림 6-6. PV는 실제 저장 공간, PVC는 그 공간을 요청하는 신청서*
...
*그림 6-7. PV와 PVC가 Bound 상태로 연결된 결과*
...
*그림 6-8. Pod가 새로 태어났는데도 c.txt가 그대로 남아 있는 모습*
...
*그림 6-9. ex08 Kubernetes 웹사이트의 전체 구성*
...
*그림 6-10. Nginx Ingress Controller 애드온 설치*
...
*그림 6-12. Ingress를 거쳐 웹사이트가 화면에 응답*
