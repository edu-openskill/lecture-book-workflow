...
```bash [실습 8] ex07/backend/entrypoint.sh. Git clone + 빌드 스크립트
#!/bin/bash
# 백엔드 소스 내려받기
...
```dockerfile [실습 9] ex07/backend/Dockerfile. Spring Boot 이미지
...
```yaml [실습 10] ex07/docker-compose.yml. ex07 전체 구성
services:
