...
<svg viewBox="0 0 1080 272" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="챕터 2 한눈에 보기: Docker Hub에서 docker pull로 이미지를 받고, docker run으로 호스트의 커널이 격리한 컨테이너를 실행한다. 컨테이너는 볼륨과 마운트로 데이터를 보존하고, commit으로 이미지로 저장한 뒤 docker push로 다시 Hub에 올린다.">
  <defs>
    <marker id="c2ov-a" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto-start-reverse"><path d="M0,0 L0,6 L8,3 z" fill="#475569"/></marker>
  </defs>
  <text x="540" y="32" text-anchor="middle" font-size="17" font-weight="700" fill="#1f2937">챕터 2 한눈에 보기 — 이미지를 받아 실행하고 보존하기까지</text>

  <rect x="600" y="70" width="450" height="172" rx="12" fill="none" stroke="#ff7849" stroke-width="1.5" stroke-dasharray="6,4"/>
  <text x="616" y="92" font-size="13" font-weight="700" fill="#7b341e">호스트 PC · 커널이 격리</text>

  <rect x="30" y="106" width="150" height="96" rx="8" fill="#fff" stroke="#475569" stroke-width="1.6"/>
  <text x="105" y="146" text-anchor="middle" font-size="15" font-weight="700" fill="#0f172a">Docker Hub</text>
  <text x="105" y="170" text-anchor="middle" font-size="13" fill="#6b7280">이미지 저장소</text>

  <rect x="320" y="106" width="150" height="96" rx="8" fill="#fff" stroke="#475569" stroke-width="1.6"/>
  <text x="395" y="146" text-anchor="middle" font-size="15" font-weight="700" fill="#0f172a">이미지</text>
  <text x="395" y="170" text-anchor="middle" font-size="13" fill="#6b7280">설계도</text>

  <rect x="620" y="106" width="160" height="96" rx="8" fill="#fff4ed" stroke="#ff7849" stroke-width="1.8"/>
  <text x="700" y="148" text-anchor="middle" font-size="15" font-weight="700" fill="#7b341e">컨테이너</text>
  <text x="700" y="172" text-anchor="middle" font-size="13" fill="#6b7280">챕터 2.5 · 2.6</text>

  <rect x="880" y="106" width="150" height="96" rx="8" fill="#fff" stroke="#ff7849" stroke-width="1.4"/>
  <text x="955" y="146" text-anchor="middle" font-size="15" font-weight="700" fill="#7b341e">볼륨</text>
  <text x="955" y="170" text-anchor="middle" font-size="13" fill="#6b7280">데이터 보존 · 챕터 2.8</text>

  <line x1="180" y1="150" x2="318" y2="150" stroke="#475569" stroke-width="1.6" marker-end="url(#c2ov-a)"/>
  <text x="249" y="128" text-anchor="middle" font-size="13" fill="#0f172a"><tspan font-weight="700">1.</tspan> docker pull</text>
  <text x="249" y="143" text-anchor="middle" font-size="13" fill="#6b7280">챕터 2.2</text>
  <line x1="318" y1="180" x2="182" y2="180" stroke="#475569" stroke-width="1.4" stroke-dasharray="5,3" marker-end="url(#c2ov-a)"/>
  <text x="249" y="200" text-anchor="middle" font-size="13" fill="#0f172a"><tspan font-weight="700">4.</tspan> docker push</text>
  <text x="249" y="215" text-anchor="middle" font-size="13" fill="#6b7280">챕터 2.7</text>

  <line x1="470" y1="150" x2="618" y2="150" stroke="#475569" stroke-width="1.6" marker-end="url(#c2ov-a)"/>
  <text x="544" y="128" text-anchor="middle" font-size="13" fill="#0f172a"><tspan font-weight="700">2.</tspan> docker run</text>
  <text x="544" y="143" text-anchor="middle" font-size="13" fill="#6b7280">챕터 2.3</text>
  <line x1="618" y1="180" x2="472" y2="180" stroke="#475569" stroke-width="1.4" stroke-dasharray="5,3" marker-end="url(#c2ov-a)"/>
  <text x="544" y="200" text-anchor="middle" font-size="13" fill="#0f172a"><tspan font-weight="700">3.</tspan> commit</text>
  <text x="544" y="215" text-anchor="middle" font-size="13" fill="#6b7280">챕터 2.7</text>

  <line x1="780" y1="154" x2="878" y2="154" stroke="#475569" stroke-width="1.6" marker-start="url(#c2ov-a)" marker-end="url(#c2ov-a)"/>
  <text x="829" y="132" text-anchor="middle" font-size="13" fill="#0f172a"><tspan font-weight="700">5.</tspan> 마운트</text>
  <text x="829" y="147" text-anchor="middle" font-size="13" fill="#6b7280">챕터 2.8</text>
</svg>
</div>
...
가상화에는 크게 두 가지 방식이 있습니다. 환경을 통째로 복제하는 **하이퍼바이저 가상화**와, 공용 부분을 함께 쓰는 **컨테이너 가상화**입니다. **Docker는 이 컨테이너 가상화를 다루는 도구입니다.**

:::note
**하이퍼바이저 가상화 vs 컨테이너 가상화**

**하이퍼바이저 가상화(Hypervisor Virtualization)** 는 호스트 OS 위에 **또 다른 OS를 통째로 올립니다.** 이렇게 떠 있는 OS 한 대가 곧 **가상 머신(VM)** 입니다. 격리는 완전하지만 OS 전체가 새로 떠야 해서 무겁고 기동이 느립니다.

반면 **컨테이너 가상화(Container Virtualization)** 는 **호스트 OS의 커널을 공유**하고, 파일시스템·네트워크·프로세스 공간만 따로 둡니다. 그 안에서 도는 격리된 단위가 **컨테이너**입니다. 커널을 공유하므로 가볍고 빠르게 뜹니다.
:::
...
<div class="svg-figure">
<svg viewBox="0 0 600 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="컨테이너 가상화 3계층 구조와 호스트 OS 안의 커널이 모든 컨테이너에 프로세스·메모리·격리를 할당하는 모습">
  <defs>
    <marker id="c2f4-ar" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#4f46e5"/></marker>
  </defs>
  ...
  <rect x="440" y="216" width="90" height="18" rx="3" fill="#eef2ff" stroke="#4f46e5" stroke-width="1.4"/>
  <text x="485" y="229" font-size="10" font-weight="800" fill="#3730a3" text-anchor="middle">Kernel</text>
  <line x1="485" y1="216" x2="410" y2="118" stroke="#4f46e5" stroke-width="1.4" stroke-dasharray="3,3" marker-end="url(#c2f4-ar)"/>
  <line x1="485" y1="216" x2="170" y2="118" stroke="#4f46e5" stroke-width="1.4" stroke-dasharray="3,3" marker-end="url(#c2f4-ar)"/>
  <text x="345" y="145" font-size="10" font-style="italic" font-weight="600" fill="#4f46e5" text-anchor="middle">프로세스 · 메모리 · 격리 할당</text>
</svg>
</div>
...
<div class="svg-figure">
<svg viewBox="0 0 800 420" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="커널은 OS의 핵심으로, 사용자 앱과 하드웨어 사이에서 프로세스·파일시스템·네트워크 같은 시스템 자원을 관리하는 중재자">
  <defs>
    <marker id="kn-d" markerWidth="8" markerHeight="8" refX="6" refY="2.5" orient="auto"><path d="M0,0 L0,5 L6,2.5 z" fill="#475569"/></marker>
  </defs>
  <text x="400" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#1f2937">커널 — OS의 핵심, 앱과 하드웨어 사이의 중재자</text>
  <g transform="translate(240, 40)">
    <rect x="0" y="0" width="56" height="42" rx="3" fill="#fff" stroke="#475569" stroke-width="1.6"/>
    <rect x="4" y="4" width="48" height="28" fill="#e0e7ff"/>
    <rect x="22" y="32" width="12" height="6" fill="#475569"/>
    <rect x="14" y="38" width="28" height="3" fill="#475569"/>
    <text x="28" y="60" text-anchor="middle" font-size="11" font-weight="700" fill="#0f172a">앱</text>
  </g>
  ...
  <line x1="262" y1="110" x2="262" y2="138" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <line x1="274" y1="138" x2="274" y2="110" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <line x1="526" y1="110" x2="526" y2="138" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <line x1="538" y1="138" x2="538" y2="110" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <rect x="120" y="140" width="560" height="160" rx="10" fill="#fff" stroke="#ff7849" stroke-width="2.4"/>
  <g transform="translate(332, 163)">
    <path d="M 30 48 Q 8 48 10 30 Q 8 12 30 14 Q 38 -4 60 4 Q 82 -6 96 10 Q 124 10 124 30 Q 128 50 102 50 Z" fill="#fff" stroke="#475569" stroke-width="1.8"/>
  </g>
  <text x="400" y="225" text-anchor="middle" font-size="14" font-weight="700" fill="#7b341e">커널</text>
  <text x="400" y="240" text-anchor="middle" font-size="10" font-style="italic" fill="#7b341e">OS의 핵심</text>
  <line x1="140" y1="252" x2="660" y2="252" stroke="#fed7aa" stroke-width="1" stroke-dasharray="4,3"/>
  <text x="400" y="266" text-anchor="middle" font-size="9" font-style="italic" fill="#94a3b8">관리하는 것</text>
  <g transform="translate(210, 273)">
    <rect x="0" y="0" width="40" height="28" rx="3" fill="#fff7ed" stroke="#ff7849" stroke-width="1.4"/>
    <line x1="8" y1="8" x2="32" y2="8" stroke="#7b341e" stroke-width="1.4"/>
    <line x1="8" y1="14" x2="32" y2="14" stroke="#7b341e" stroke-width="1.4"/>
    <line x1="8" y1="20" x2="32" y2="20" stroke="#7b341e" stroke-width="1.4"/>
    <circle cx="5" cy="8" r="1.4" fill="#7b341e"/>
    <circle cx="5" cy="14" r="1.4" fill="#7b341e"/>
    <circle cx="5" cy="20" r="1.4" fill="#7b341e"/>
  </g>
  <text x="230" y="316" text-anchor="middle" font-size="11" font-weight="700" fill="#0f172a">프로세스</text>
  <g transform="translate(380, 273)">
    <path d="M 0 8 L 0 28 L 40 28 L 40 4 L 16 4 L 12 8 Z" fill="#fff7ed" stroke="#ff7849" stroke-width="1.4"/>
    <line x1="0" y1="10" x2="40" y2="10" stroke="#ff7849" stroke-width="0.8"/>
  </g>
  <text x="400" y="316" text-anchor="middle" font-size="11" font-weight="700" fill="#0f172a">파일시스템</text>
  <g transform="translate(550, 273)">
    <rect x="0" y="0" width="40" height="28" rx="3" fill="#fff7ed" stroke="#ff7849" stroke-width="1.4"/>
    <circle cx="10" cy="9" r="3" fill="#7b341e"/>
    <circle cx="30" cy="9" r="3" fill="#7b341e"/>
    <circle cx="20" cy="21" r="3" fill="#7b341e"/>
    <line x1="10" y1="9" x2="30" y2="9" stroke="#7b341e" stroke-width="1.2"/>
    <line x1="10" y1="9" x2="20" y2="21" stroke="#7b341e" stroke-width="1.2"/>
    <line x1="30" y1="9" x2="20" y2="21" stroke="#7b341e" stroke-width="1.2"/>
  </g>
  <text x="570" y="316" text-anchor="middle" font-size="11" font-weight="700" fill="#0f172a">네트워크</text>
  <line x1="224" y1="332" x2="224" y2="358" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <line x1="236" y1="358" x2="236" y2="332" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <line x1="394" y1="332" x2="394" y2="358" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <line x1="406" y1="358" x2="406" y2="332" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <line x1="564" y1="332" x2="564" y2="358" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <line x1="576" y1="358" x2="576" y2="332" stroke="#475569" stroke-width="1.4" marker-end="url(#kn-d)"/>
  <g transform="translate(210, 358)">
    <rect x="0" y="0" width="40" height="32" rx="2" fill="#fff" stroke="#475569" stroke-width="1.6"/>
    <rect x="6" y="6" width="28" height="20" fill="#e2e8f0" stroke="#475569" stroke-width="0.8"/>
    <line x1="0" y1="10" x2="-4" y2="10" stroke="#475569" stroke-width="1.4"/>
    <line x1="0" y1="20" x2="-4" y2="20" stroke="#475569" stroke-width="1.4"/>
    <line x1="40" y1="10" x2="44" y2="10" stroke="#475569" stroke-width="1.4"/>
    <line x1="40" y1="20" x2="44" y2="20" stroke="#475569" stroke-width="1.4"/>
  </g>
  <text x="230" y="406" text-anchor="middle" font-size="11" font-weight="700" fill="#0f172a">CPU</text>
  <g transform="translate(550, 358)">
    <rect x="0" y="0" width="40" height="32" rx="2" fill="#fff" stroke="#475569" stroke-width="1.6"/>
    <rect x="4" y="6" width="6" height="16" fill="#cbd5e1"/>
    <rect x="13" y="6" width="6" height="16" fill="#cbd5e1"/>
    <rect x="22" y="6" width="6" height="16" fill="#cbd5e1"/>
    <rect x="31" y="6" width="6" height="16" fill="#cbd5e1"/>
    <line x1="0" y1="28" x2="40" y2="28" stroke="#475569" stroke-width="0.6"/>
  </g>
  <text x="570" y="406" text-anchor="middle" font-size="11" font-weight="700" fill="#0f172a">메모리</text>
  <g transform="translate(380, 358)">
    <ellipse cx="20" cy="6" rx="18" ry="4" fill="#fff" stroke="#475569" stroke-width="1.4"/>
    <path d="M 2 6 L 2 26 Q 20 30 38 26 L 38 6" fill="#fff" stroke="#475569" stroke-width="1.4"/>
    <ellipse cx="20" cy="14" rx="18" ry="3" fill="none" stroke="#475569" stroke-width="0.8"/>
    <ellipse cx="20" cy="22" rx="18" ry="3" fill="none" stroke="#475569" stroke-width="0.8"/>
  </g>
  <text x="400" y="406" text-anchor="middle" font-size="11" font-weight="700" fill="#0f172a">디스크</text>
</svg>
</div>
...
사실 컨테이너 안에서 도는 것은 처음부터 격리된 무언가가 아니라, 호스트 OS 위에서 다른 것들과 함께 도는 **평범한 프로세스**입니다. 그대로 두면 한 컨테이너의 프로세스가 다른 컨테이너의 파일을 들여다보거나, 두 컨테이너가 같은 포트를 두고 충돌할 수 있습니다.
그래서 **리눅스 커널**은 컨테이너마다 **파일시스템**(`/bin`, `/lib` 같은 폴더), **네트워크**(IP와 포트), **프로세스**(PID 번호) 세 가지 공간을 따로 만들어 줍니다. 커널이 이렇게 따로 만들어 주는 공간을 **네임스페이스(Namespace)** 라고 합니다. 컨테이너마다 자기 네임스페이스를 갖는 이 상태가 바로 **격리**입니다.
:::
...
지금까지는 컨테이너가 **무엇인지**를 살펴봤습니다. 그렇다면 이 컨테이너는 **어떻게** 만들어질까요. 명령어를 실행했을 때 무엇이 어떤 순서로 일어나는지 따라가 보겠습니다.

<div class="svg-figure">
<svg viewBox="0 0 760 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="컨테이너 실행 명령이 Docker 엔진을 거쳐 커널에 전달되고, 커널이 격리된 프로세스를 만들어 컨테이너가 되는 흐름">
  <defs>
    <marker id="cf-p" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#475569"/></marker>
    <marker id="cf-r" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#dc2626"/></marker>
  </defs>
  <text x="380" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#1f2937">실행 명령 → Docker Engine → 커널 → 컨테이너</text>
  <g transform="translate(30, 70)">
    <rect width="140" height="60" rx="4" fill="#fff" stroke="#475569" stroke-width="1.6"/>
    <rect width="140" height="16" rx="4" fill="#0f172a"/>
    <circle cx="10" cy="8" r="2.5" fill="#dc2626"/>
    <circle cx="20" cy="8" r="2.5" fill="#fbbf24"/>
    <circle cx="30" cy="8" r="2.5" fill="#10b981"/>
    <text x="14" y="42" font-family="monospace" font-size="13" font-weight="700" fill="#0f172a">$ docker run</text>
  </g>
  <text x="100" y="155" text-anchor="middle" font-size="12" font-weight="700" fill="#0f172a">실행 명령</text>
  <line x1="172" y1="100" x2="218" y2="100" stroke="#475569" stroke-width="1.6" marker-end="url(#cf-p)"/>
  <text x="195" y="92" text-anchor="middle" font-size="10" font-style="italic" fill="#475569">전달</text>
  <g transform="translate(220, 70)">
    <rect width="140" height="60" rx="6" fill="#fff" stroke="#475569" stroke-width="1.6"/>
    <rect x="14" y="12" width="112" height="14" rx="2" fill="#fff" stroke="#94a3b8" stroke-width="1"/>
    <circle cx="22" cy="19" r="1.5" fill="#94a3b8"/>
    <rect x="14" y="30" width="112" height="14" rx="2" fill="#fff" stroke="#94a3b8" stroke-width="1"/>
    <circle cx="22" cy="37" r="1.5" fill="#94a3b8"/>
  </g>
  <text x="290" y="155" text-anchor="middle" font-size="12" font-weight="700" fill="#0f172a">Docker Engine</text>
  <line x1="362" y1="100" x2="418" y2="100" stroke="#dc2626" stroke-width="1.6" stroke-dasharray="5,3" marker-end="url(#cf-r)"/>
  <text x="390" y="84" text-anchor="middle" font-size="10" font-style="italic" fill="#b91c1c">이미지로</text>
  <text x="390" y="96" text-anchor="middle" font-size="10" font-style="italic" fill="#b91c1c">격리 요청</text>
  <g transform="translate(420, 76)">
    <path d="M 30 48 Q 8 48 10 30 Q 8 12 30 14 Q 38 -4 60 4 Q 82 -6 96 10 Q 124 10 124 30 Q 128 50 102 50 Z" fill="#fff" stroke="#475569" stroke-width="1.8"/>
  </g>
  <text x="488" y="155" text-anchor="middle" font-size="12" font-weight="700" fill="#0f172a">OS 커널</text>
  <line x1="555" y1="100" x2="612" y2="100" stroke="#dc2626" stroke-width="1.6" marker-end="url(#cf-r)"/>
  <text x="582" y="92" text-anchor="middle" font-size="10" font-style="italic" fill="#b91c1c">프로세스 생성</text>
  <g transform="translate(620, 75)" stroke="#ff7849" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <path d="M 0 12 L 18 0 L 68 0 L 50 12 Z" stroke-width="1.8" fill="#fff4ed"/>
    <path d="M 50 12 L 68 0 L 68 40 L 50 52 Z" stroke-width="1.8" fill="#fff4ed"/>
    <rect x="0" y="12" width="50" height="40" stroke-width="1.8" fill="#fff4ed"/>
    <line x1="10" y1="14" x2="10" y2="50" stroke-width="1.2"/>
    <line x1="20" y1="14" x2="20" y2="50" stroke-width="1.2"/>
    <line x1="30" y1="14" x2="30" y2="50" stroke-width="1.2"/>
    <line x1="40" y1="14" x2="40" y2="50" stroke-width="1.2"/>
  </g>
  <text x="654" y="155" text-anchor="middle" font-size="12" font-weight="700" fill="#7b341e">컨테이너</text>
</svg>
</div>
...
**이미지(Image)** 는 컨테이너가 무엇을 실행할지를 담은 **설계도**입니다. 이미지에는 무엇을 어떻게 실행할지가 모두 담겨 있고, 그 설계도를 실제로 실행한 것이 컨테이너입니다.

<div class="svg-figure">
<svg viewBox="0 0 720 270" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="하나의 이미지(설계도) 한 장으로 동일한 컨테이너 세 개를 찍어내는 구조">
  <defs>
    <marker id="img-p" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#475569"/></marker>
  </defs>
  <text x="360" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#1f2937">이미지 한 장으로 같은 컨테이너를 여러 개 찍어낸다</text>
  <g transform="translate(80, 120)" stroke="#475569" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <rect width="72" height="60" rx="4" stroke-width="1.8" fill="#fff"/>
    <circle cx="16" cy="16" r="5" stroke-width="1.5" fill="#fff"/>
    <path d="M 4 48 L 22 22 L 34 34 L 50 18 L 68 48 Z" stroke-width="1.5" fill="#fff"/>
    <line x1="0" y1="48" x2="72" y2="48" stroke-width="1.3"/>
  </g>
  <text x="116" y="200" text-anchor="middle" font-size="12" font-weight="700" fill="#0f172a">이미지 (설계도)</text>
  <line x1="155" y1="150" x2="395" y2="82" stroke="#475569" stroke-width="1.6" marker-end="url(#img-p)"/>
  <line x1="155" y1="150" x2="395" y2="150" stroke="#475569" stroke-width="1.6" marker-end="url(#img-p)"/>
  <line x1="155" y1="150" x2="395" y2="218" stroke="#475569" stroke-width="1.6" marker-end="url(#img-p)"/>
  <text x="270" y="110" text-anchor="middle" font-size="10" font-style="italic" fill="#6b7280">찍어내기</text>
  <g transform="translate(400, 50)" stroke="#ff7849" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <path d="M 0 12 L 18 0 L 68 0 L 50 12 Z" stroke-width="1.8" fill="#fff4ed"/>
    <path d="M 50 12 L 68 0 L 68 40 L 50 52 Z" stroke-width="1.8" fill="#fff4ed"/>
    <rect x="0" y="12" width="50" height="40" stroke-width="1.8" fill="#fff4ed"/>
    <line x1="10" y1="14" x2="10" y2="50" stroke-width="1.2"/>
  ...
  <text x="478" y="86" font-size="13" font-weight="700" fill="#7b341e">컨테이너 1</text>
  <g transform="translate(400, 118)" stroke="#ff7849" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <path d="M 0 12 L 18 0 L 68 0 L 50 12 Z" stroke-width="1.8" fill="#fff4ed"/>
    <path d="M 50 12 L 68 0 L 68 40 L 50 52 Z" stroke-width="1.8" fill="#fff4ed"/>
    <rect x="0" y="12" width="50" height="40" stroke-width="1.8" fill="#fff4ed"/>
    <line x1="10" y1="14" x2="10" y2="50" stroke-width="1.2"/>
  ...
  <text x="478" y="154" font-size="13" font-weight="700" fill="#7b341e">컨테이너 2</text>
  <g transform="translate(400, 186)" stroke="#ff7849" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <path d="M 0 12 L 18 0 L 68 0 L 50 12 Z" stroke-width="1.8" fill="#fff4ed"/>
    <path d="M 50 12 L 68 0 L 68 40 L 50 52 Z" stroke-width="1.8" fill="#fff4ed"/>
    <rect x="0" y="12" width="50" height="40" stroke-width="1.8" fill="#fff4ed"/>
    <line x1="10" y1="14" x2="10" y2="50" stroke-width="1.2"/>
  ...
  <text x="478" y="222" font-size="13" font-weight="700" fill="#7b341e">컨테이너 3</text>
</svg>
</div>
...
<div class="svg-figure">
<svg viewBox="0 0 780 350" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="이미지를 실행하면 이미지 레이어 묶음 위에서 프로그램이 도는 컨테이너가 되는 모습">
  <defs>
    <marker id="arrowA" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L9,3 z" fill="#475569"/></marker>
  </defs>
  <text x="390" y="30" text-anchor="middle" font-size="15" font-weight="700" fill="#1f2937">이미지를 실행하면 컨테이너가 됩니다</text>
  <text x="195" y="66" text-anchor="middle" font-size="13" font-weight="700" fill="#334155">이미지</text>
  <rect x="70" y="76" width="250" height="184" rx="8" fill="#fff" stroke="#475569" stroke-width="2"/>
  <rect x="88" y="90" width="214" height="38" rx="4" fill="#fff4ed" stroke="#ff7849" stroke-width="1.7"/>
  <text x="195" y="114" text-anchor="middle" font-size="12" font-weight="700" fill="#7b341e">애플리케이션 코드</text>
  <rect x="88" y="132" width="214" height="38" rx="4" fill="#f1f5f9" stroke="#475569" stroke-width="1.5"/>
  <text x="195" y="156" text-anchor="middle" font-size="12" font-weight="700" fill="#334155">런타임</text>
  <rect x="88" y="174" width="214" height="38" rx="4" fill="#f1f5f9" stroke="#475569" stroke-width="1.5"/>
  <text x="195" y="198" text-anchor="middle" font-size="12" font-weight="700" fill="#334155">시스템 라이브러리</text>
  <rect x="88" y="216" width="214" height="38" rx="4" fill="#e2e8f0" stroke="#475569" stroke-width="1.7"/>
  <text x="195" y="240" text-anchor="middle" font-size="12" font-weight="700" fill="#334155">기반 리눅스 파일</text>
  <line x1="332" y1="168" x2="452" y2="168" stroke="#475569" stroke-width="2" marker-end="url(#arrowA)"/>
  <text x="392" y="158" text-anchor="middle" font-size="13" font-weight="700" fill="#0f172a">실행</text>
  <text x="585" y="50" text-anchor="middle" font-size="13" font-weight="700" fill="#7b341e">컨테이너</text>
  <rect x="460" y="60" width="250" height="234" rx="8" fill="#fff" stroke="#ff7849" stroke-width="2.2"/>
  <rect x="478" y="74" width="214" height="42" rx="4" fill="#eef2ff" stroke="#4f46e5" stroke-width="1.8"/>
  <text x="585" y="100" text-anchor="middle" font-size="13" font-weight="800" fill="#3730a3">프로세스</text>
  <rect x="478" y="124" width="214" height="34" rx="4" fill="#fff4ed" stroke="#ff7849" stroke-width="1.6"/>
  <text x="585" y="145" text-anchor="middle" font-size="11.5" font-weight="700" fill="#7b341e">애플리케이션 코드</text>
  <rect x="478" y="162" width="214" height="34" rx="4" fill="#f1f5f9" stroke="#475569" stroke-width="1.4"/>
  <text x="585" y="183" text-anchor="middle" font-size="11.5" font-weight="700" fill="#334155">런타임</text>
  <rect x="478" y="200" width="214" height="34" rx="4" fill="#f1f5f9" stroke="#475569" stroke-width="1.4"/>
  <text x="585" y="221" text-anchor="middle" font-size="11.5" font-weight="700" fill="#334155">시스템 라이브러리</text>
  <rect x="478" y="238" width="214" height="34" rx="4" fill="#e2e8f0" stroke="#475569" stroke-width="1.6"/>
  <text x="585" y="259" text-anchor="middle" font-size="11.5" font-weight="700" fill="#334155">기반 리눅스 파일</text>
</svg>
</div>

*그림 2-9. 이미지를 실행하면 레이어 묶음 위에서 프로그램이 도는 컨테이너가 됩니다*

맨 아래 세 레이어(**기반 리눅스 파일·시스템 라이브러리·런타임**)는 여러 앱이 공통으로 쓰는 **거의 바뀌지 않는** 부분이고, 맨 위 레이어(**애플리케이션 코드**)는 그 앱에서만 쓰는 **자주 바뀌는** 코드입니다. 그래서 코드만 바뀐 새 버전을 만들 때도 아래 세 레이어는 그대로 재사용하고, 바뀐 맨 위 레이어만 새로 만듭니다.
...
<div class="svg-figure">
<svg viewBox="0 0 760 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Docker Hub와 이미지, 컨테이너 사이의 내려받기·올리기·실행·저장 전체 흐름">
  <defs>
    <marker id="dk-p" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#475569"/></marker>
  </defs>
  <text x="380" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#1f2937">Docker 전체 흐름 — Hub · 이미지 · 컨테이너</text>
  <g transform="translate(40, 60)">
    <path d="M 30 38 Q 10 38 10 22 Q 10 6 28 8 Q 36 -8 56 0 Q 76 -8 90 6 Q 116 6 116 24 Q 116 40 96 40 Z" fill="#fff" stroke="#475569" stroke-width="1.8"/>
  </g>
  <text x="103" y="140" text-anchor="middle" font-size="12" font-weight="700" fill="#0f172a">Docker Hub</text>
  <g transform="translate(344, 60)" stroke="#475569" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <rect width="72" height="60" rx="4" stroke-width="1.8" fill="#fff"/>
    <circle cx="16" cy="16" r="5" stroke-width="1.5" fill="#fff"/>
    <path d="M 4 48 L 22 22 L 34 34 L 50 18 L 68 48 Z" stroke-width="1.5" fill="#fff"/>
    <line x1="0" y1="48" x2="72" y2="48" stroke-width="1.3"/>
  </g>
  <text x="380" y="140" text-anchor="middle" font-size="12" font-weight="700" fill="#0f172a">이미지</text>
  <g transform="translate(636, 64)" stroke="#ff7849" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <path d="M 0 12 L 18 0 L 68 0 L 50 12 Z" stroke-width="1.8" fill="#fff4ed"/>
    <path d="M 50 12 L 68 0 L 68 40 L 50 52 Z" stroke-width="1.8" fill="#fff4ed"/>
    <rect x="0" y="12" width="50" height="40" stroke-width="1.8" fill="#fff4ed"/>
    <line x1="10" y1="14" x2="10" y2="50" stroke-width="1.2"/>
  ...
  <text x="670" y="140" text-anchor="middle" font-size="12" font-weight="700" fill="#7b341e">컨테이너</text>
  <line x1="158" y1="80" x2="341" y2="80" stroke="#475569" stroke-width="1.6" stroke-dasharray="5,3" marker-end="url(#dk-p)"/>
  <text x="249" y="73" text-anchor="middle" font-size="11" font-weight="600" fill="#0f172a">내려받기</text>
  <line x1="341" y1="108" x2="158" y2="108" stroke="#475569" stroke-width="1.6" stroke-dasharray="5,3" marker-end="url(#dk-p)"/>
  <text x="249" y="124" text-anchor="middle" font-size="11" font-weight="600" fill="#0f172a">올리기</text>
  <line x1="419" y1="80" x2="633" y2="80" stroke="#475569" stroke-width="1.6" stroke-dasharray="5,3" marker-end="url(#dk-p)"/>
  <text x="526" y="73" text-anchor="middle" font-size="11" font-weight="600" fill="#0f172a">실행</text>
  <line x1="633" y1="108" x2="419" y2="108" stroke="#475569" stroke-width="1.6" stroke-dasharray="5,3" marker-end="url(#dk-p)"/>
  <text x="526" y="124" text-anchor="middle" font-size="11" font-weight="600" fill="#0f172a">저장</text>
</svg>
</div>
...
<div class="terminal-log">
  ...
  <div class="tl-body">
    ...
    <div>9baba07a35b6: Pull complete</div>
    <div>ec781dde3f47: Pull complete</div>
    <div>0289d65812c3: Pull complete</div>
    <div>4174e33a2c9e: Pull complete</div>
    <div>6b40784e4837: Pull complete</div>
    <div>980067d12da2: Pull complete</div>
    <div>f0b77348d9b0: Pull complete</div>
    <div>00238b7dc6b2: Pull complete</div>
    <div>Digest: sha256:9b3a2dde20b8a1b5e9f2c4a6d8e0b3f5a7c9e1b3d5f7a9b1c3e5f7a9b1c3e5f7</div>
    <div>Status: Downloaded newer image for nginx:latest</div>
    <div>docker.io/library/nginx:latest</div>
    <div><span class="tl-key">$</span></div>
  </div>
</div>
...
<table style="width:100%; border-collapse:collapse;">
  <thead>
    <tr>
      <th style="width:38%; text-align:left;">명령어</th>
      <th style="text-align:left;">설명</th>
    </tr>
  </thead>
  <tbody>
    <tr><td style="white-space:nowrap;"><strong>docker pull &lt;이미지명&gt;</strong></td><td>Docker Hub에서 이미지 다운로드</td></tr>
    <tr><td style="white-space:nowrap;"><strong>docker images</strong></td><td>로컬에 저장된 이미지 목록</td></tr>
    <tr><td style="white-space:nowrap;"><strong>docker logs &lt;컨테이너ID&gt;</strong></td><td>컨테이너 로그 출력</td></tr>
    <tr><td style="white-space:nowrap;"><strong>docker ps -a</strong></td><td>종료된 컨테이너 포함 전체 목록</td></tr>
    <tr><td style="white-space:nowrap;"><strong>docker stop &lt;컨테이너ID&gt;</strong></td><td>실행 중인 컨테이너 종료</td></tr>
    <tr><td style="white-space:nowrap;"><strong>docker rm &lt;컨테이너ID&gt;</strong></td><td>종료된 컨테이너 삭제</td></tr>
    <tr><td style="white-space:nowrap;"><strong>docker rmi &lt;이미지ID&gt;</strong></td><td>이미지 삭제</td></tr>
  </tbody>
</table>
...
<div class="svg-figure">
<svg viewBox="0 0 900 460" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="컨테이너 통신 도입. 외부 브라우저가 호스트 포트로 들어와 iptables를 거쳐 docker0 위 web 컨테이너로 닿고, web과 db는 docker0 위에서 IP로 통신.">
  <defs>
    <marker id="n15-p" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#475569"/></marker>
    <marker id="n15-s" markerWidth="10" markerHeight="10" refX="2" refY="3" orient="auto-start-reverse"><path d="M0,0 L0,6 L8,3 z" fill="#475569"/></marker>
  </defs>
  <text x="450" y="28" text-anchor="middle" font-size="14" font-weight="700" fill="#1f2937">컨테이너 통신 한눈에 보기</text>
  <rect x="20" y="155" width="140" height="70" rx="6" fill="#fff" stroke="#475569" stroke-width="1.6"/>
  <text x="90" y="183" text-anchor="middle" font-size="12" font-weight="700" fill="#0f172a">브라우저</text>
  <text x="90" y="205" text-anchor="middle" font-size="11" font-family="monospace" fill="#4f46e5">localhost:8080</text>
  <rect x="200" y="50" width="690" height="400" rx="10" fill="#fff" stroke="#94a3b8" stroke-width="2" stroke-dasharray="6,4"/>
  <text x="220" y="74" font-size="12" font-weight="700" fill="#475569">호스트 PC</text>
  <rect x="220" y="160" width="100" height="60" rx="6" fill="#fff" stroke="#475569" stroke-width="1.4"/>
  <text x="270" y="183" text-anchor="middle" font-size="11" font-weight="600" fill="#0f172a">호스트 포트</text>
  <text x="270" y="206" text-anchor="middle" font-size="14" font-weight="700" font-family="monospace" fill="#0f172a">:8080</text>
  <rect x="345" y="155" width="135" height="70" rx="6" fill="#f5faff" stroke="#1565c0" stroke-width="1.6"/>
  <text x="412" y="178" text-anchor="middle" font-size="12" font-weight="700" fill="#1565c0">iptables 규칙</text>
  <text x="412" y="194" text-anchor="middle" font-size="10" font-style="italic" fill="#1565c0">DNAT</text>
  <text x="412" y="213" text-anchor="middle" font-size="11" font-family="monospace" fill="#1565c0">8080 → :80</text>
  <rect x="280" y="257" width="530" height="46" rx="23" fill="#fff4ed" stroke="#ff7849" stroke-width="2"/>
  <rect x="290" y="325" width="200" height="110" rx="6" fill="#fff" stroke="#9ca3af" stroke-width="1.4" stroke-dasharray="5,3"/>
  <text x="302" y="340" font-size="9" font-weight="600" fill="#6b7280">Namespace A</text>
  <rect x="302" y="348" width="176" height="78" rx="4" fill="#fff" stroke="#475569" stroke-width="1.6"/>
  <text x="390" y="372" text-anchor="middle" font-size="13" font-weight="800" fill="#0f172a">web 컨테이너</text>
  <text x="390" y="392" text-anchor="middle" font-size="10" font-family="monospace" fill="#6b7280">172.17.0.2</text>
  <text x="390" y="410" text-anchor="middle" font-size="10" font-family="monospace" fill="#6b7280">port: 80</text>
  <rect x="580" y="325" width="200" height="110" rx="6" fill="#fff" stroke="#9ca3af" stroke-width="1.4" stroke-dasharray="5,3"/>
  <text x="592" y="340" font-size="9" font-weight="600" fill="#6b7280">Namespace B</text>
  <rect x="592" y="348" width="176" height="78" rx="4" fill="#fff" stroke="#475569" stroke-width="1.6"/>
  <text x="680" y="372" text-anchor="middle" font-size="13" font-weight="800" fill="#0f172a">db 컨테이너</text>
  <text x="680" y="392" text-anchor="middle" font-size="10" font-family="monospace" fill="#6b7280">172.17.0.3</text>
  <text x="680" y="410" text-anchor="middle" font-size="10" font-family="monospace" fill="#6b7280">port: 3306</text>
  <line x1="160" y1="190" x2="218" y2="190" stroke="#475569" stroke-width="1.8" marker-end="url(#n15-p)"/>
  <line x1="320" y1="190" x2="345" y2="190" stroke="#475569" stroke-width="1.6" marker-end="url(#n15-p)"/>
  <path d="M 412 225 L 412 255" fill="none" stroke="#475569" stroke-width="1.6" marker-end="url(#n15-p)"/>
  <line x1="390" y1="303" x2="390" y2="325" stroke="#475569" stroke-width="1.6" stroke-dasharray="4,3" marker-end="url(#n15-p)"/>
  <text x="398" y="318" font-size="9" font-style="italic" fill="#6b7280">veth</text>
  <line x1="680" y1="303" x2="680" y2="325" stroke="#475569" stroke-width="1.6" stroke-dasharray="4,3" marker-end="url(#n15-p)"/>
  <text x="688" y="318" font-size="9" font-style="italic" fill="#6b7280">veth</text>
  <path d="M 478 348 Q 535 245 580 348" fill="none" stroke="#475569" stroke-width="1.7" stroke-dasharray="5,3" marker-start="url(#n15-s)" marker-end="url(#n15-p)"/>
  <text x="535" y="318" text-anchor="middle" font-size="10" font-style="italic" font-weight="700" fill="#475569">IP로 통신</text>
  <text x="545" y="287" text-anchor="middle"><tspan font-size="13" font-weight="800" fill="#7b341e">docker0 브리지 (가상 스위치)</tspan><tspan font-size="10" font-family="monospace" fill="#7b341e">  ·  172.17.0.1</tspan></text>
</svg>
</div>
...
컨테이너끼리는 어떻게 데이터를 주고받을까요? 푸드코트를 예로 들어 보겠습니다.
...
*그림 2-16. 주방 모니터·전용 통신 케이블·주문 전광판이 컨테이너 네트워크의 비유*

이 비유를 IT로 옮기면 다음과 같습니다.

| 푸드코트 | IT 용어 | 한 줄 설명 |
|:-------:|:--------|:----------|
| 주방 모니터 | **네트워크 Namespace** | 컨테이너마다 따로 가진, 자기 IP·포트를 쓰는 격리된 네트워크입니다 |
| 전용 통신 케이블 | **veth pair** | 네트워크 Namespace를 docker0에 잇는 가상 케이블 한 쌍입니다 |
| 주문 전광판 | **docker0** | 같은 브리지에 묶인 컨테이너 사이로 패킷(데이터 묶음)을 중계하는 가상 브리지입니다 |

2.1.2의 컨테이너 격리에서 본 **네트워크 네임스페이스는 컨테이너가 실행되는 순간 케이블(veth pair)을 통해 docker0에 연결됩니다.** 그러면 Docker가 아직 아무도 쓰지 않는 IP 하나를 골라 이 네임스페이스에 부여합니다.

이제 A 컨테이너가 B의 IP로 호출하면 데이터는 **A → docker0 → B** 순서로 흐릅니다.

<div class="svg-figure">
<svg viewBox="0 0 760 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="컨테이너가 자기 네트워크 Namespace(격리된 IP 공간)를 갖고 veth pair로 docker0에 연결되는 구조">
  <defs>
    <marker id="ns-ah" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="#475569"/>
    </marker>
    <marker id="ns-ah-s" markerWidth="10" markerHeight="10" refX="2" refY="3" orient="auto-start-reverse">
      <path d="M0,0 L0,6 L8,3 z" fill="#475569"/>
    </marker>
  </defs>
  <text x="380" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#1f2937">컨테이너 네트워크 격리 구조 - 컨테이너 · Namespace · docker0</text>

  <!-- 호스트 박스 (전체 확장) -->
  <rect x="20" y="50" width="720" height="200" rx="8" fill="#fff" stroke="#475569" stroke-width="1.6"/>
  <text x="380" y="70" text-anchor="middle" font-size="11" font-weight="600" fill="#0f172a">호스트 (Host)</text>

  <!-- 컨테이너 A (바깥) ⊃ 네트워크 Namespace (안) -->
  <rect x="40" y="85" width="180" height="150" rx="8" fill="#fff" stroke="#ff7849" stroke-width="1.9"/>
  <text x="130" y="104" text-anchor="middle" font-size="13" font-weight="700" fill="#7b341e">컨테이너 A</text>
  <rect x="57" y="116" width="146" height="102" rx="6" fill="#fff4ed" stroke="#fb923c" stroke-width="1.4" stroke-dasharray="5,3"/>
  <text x="130" y="137" text-anchor="middle" font-size="10.5" font-weight="700" fill="#7b341e">네트워크 Namespace</text>
  <text x="130" y="153" text-anchor="middle" font-size="9" font-style="italic" fill="#9a3f1c">격리된 네트워크</text>
  <rect x="73" y="166" width="114" height="30" rx="5" fill="#fff" stroke="#fb923c" stroke-width="1.2"/>
  <text x="130" y="186" text-anchor="middle" font-size="11" font-family="monospace" fill="#7b341e">172.17.0.2</text>
  ...
  <!-- 컨테이너 B (바깥) ⊃ 네트워크 Namespace (안) -->
  <rect x="540" y="85" width="180" height="150" rx="8" fill="#fff" stroke="#ff7849" stroke-width="1.9"/>
  <text x="630" y="104" text-anchor="middle" font-size="13" font-weight="700" fill="#7b341e">컨테이너 B</text>
  <rect x="557" y="116" width="146" height="102" rx="6" fill="#fff4ed" stroke="#fb923c" stroke-width="1.4" stroke-dasharray="5,3"/>
  <text x="630" y="137" text-anchor="middle" font-size="10.5" font-weight="700" fill="#7b341e">네트워크 Namespace</text>
  <text x="630" y="153" text-anchor="middle" font-size="9" font-style="italic" fill="#9a3f1c">격리된 네트워크</text>
  <rect x="573" y="166" width="114" height="30" rx="5" fill="#fff" stroke="#fb923c" stroke-width="1.2"/>
  <text x="630" y="186" text-anchor="middle" font-size="11" font-family="monospace" fill="#7b341e">172.17.0.3</text>

  <!-- veth pair: 컨테이너 A ↔ docker0 -->
  <line x1="220" y1="160" x2="318" y2="160" stroke="#475569" stroke-width="1.6" stroke-dasharray="5,3" marker-start="url(#ns-ah-s)" marker-end="url(#ns-ah)"/>
  <text x="269" y="153" text-anchor="middle" font-size="10" fill="#6b7280" font-style="italic">veth pair</text>

  <!-- veth pair: docker0 ↔ 컨테이너 B -->
  <line x1="442" y1="160" x2="540" y2="160" stroke="#475569" stroke-width="1.6" stroke-dasharray="5,3" marker-start="url(#ns-ah-s)" marker-end="url(#ns-ah)"/>
  <text x="491" y="153" text-anchor="middle" font-size="10" fill="#6b7280" font-style="italic">veth pair</text>
</svg>
</div>

*그림 2-17. 컨테이너 네트워크 격리 구조*

*'각 컨테이너는 격리되어 있지만 docker0를 통해 서로 통신하는구나.'*

오픈이가 다음으로 알아본 건 외부에서 온 요청이 컨테이너로 어떻게 들어오느냐였습니다.

### 2.4.2 외부에서 들어오기 - 입구 키오스크

`docker run`으로 띄운 컨테이너는 docker0가 만드는 **기본 네트워크**에 자동으로 들어갑니다. 같은 네트워크 안의 컨테이너끼리는 IP만 알면 통신할 수 있지만, **외부에서는 컨테이너의 IP로 바로 접근할 수 없습니다**. 두 가지 이유가 있습니다.

- Windows·macOS에서는 컨테이너가 **Docker Desktop 속 가상 리눅스 안에서 실행되기** 때문에, 외부는 물론 호스트에서도 컨테이너 IP로 바로 접근하기 어렵습니다.
- 게다가 컨테이너 IP는 **새로 띄울 때마다 바뀌어서**, 외부에서 늘 같은 주소로 접근할 수 없습니다.

그래서 외부에서 컨테이너로 들어오는 **별도의 통로**가 필요합니다.
...
*그림 2-18. 입구 키오스크가 손님의 주문을 각 식당으로 넘겨주는 비유*

이 비유를 IT로 옮기면 다음과 같습니다.

| 푸드코트 | IT 용어 | 한 줄 설명 |
|:-------:|:--------|:----------|
| 입구 키오스크 | **포트포워딩** | 외부 공개 포트로 온 주문을 컨테이너 포트로 넘기는 메커니즘입니다 |
| 키오스크의 "돈까스 → B식당" 매핑 | **iptables 규칙(DNAT)** | 외부 공개 포트로 온 요청의 목적지를 컨테이너의 IP와 포트로 바꾸는 규칙입니다 |
| 주문이 전달되는 식당 | **컨테이너 포트** | 키오스크가 주문을 넘기는 곳으로, 컨테이너 안에서 앱이 듣고 있는 포트입니다 |
...
<svg viewBox="0 0 760 290" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="포트포워딩 구조 — iptables 규칙이 호스트 포트로 들어온 요청을 컨테이너 포트로 전달하는 구조">
  ...
  <!-- 브라우저 → 호스트 포트 화살표 (호스트 박스 위에 그려 가려지지 않게) -->
  <line x1="160" y1="140" x2="218" y2="140" stroke="#475569" stroke-width="1.8" marker-end="url(#pf-ah)"/>
...
*그림 2-19. 호스트 포트가 컨테이너 포트로 연결되는 구조*

*'내 컴퓨터 포트와 컨테이너 포트를 포트포워딩으로 연결해 줘야 외부 요청이 안으로 들어올 수 있는 거네.'*
...
*그림 2-20. 안내 지도가 이름을 위치로 바꿔주는 비유*
...
새 컨테이너가 뜰 때마다 이름과 IP가 자동으로 **Docker DNS**에 등록됩니다. 그 다음 app 컨테이너가 db라는 이름으로 요청을 보냅니다. 그러면 Docker DNS가 먼저 받아 **db라는 이름을 실제 IP로 변환**해 알려줍니다. app 컨테이너는 그 IP로 다시 요청을 보냅니다. 컨테이너가 다시 떠서 IP가 바뀌어도 **같은 이름으로 통신할 수 있습니다**.

<div class="svg-figure">
<svg viewBox="0 0 700 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Docker DNS가 이름을 IP로 변환하는 흐름">
  <defs>
  ...
  <rect x="10" y="25" width="680" height="195" rx="8" fill="#eef2ff" stroke="#4f46e5" stroke-width="1.5" stroke-dasharray="5,4" opacity="0.4"/>
  <text x="22" y="44" font-size="11" font-weight="800" fill="#3730a3">사용자 정의 네트워크(User-defined Network)</text>
  <rect x="20" y="70" width="160" height="70" rx="8" fill="#fff" stroke="#475569" stroke-width="1.8"/>
  <text x="100" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#0f172a">app 컨테이너</text>
  <text x="100" y="120" text-anchor="middle" font-size="11" font-family="monospace" fill="#6b7280">172.18.0.2</text>
  <rect x="270" y="70" width="160" height="70" rx="8" fill="#fff4ed" stroke="#ff7849" stroke-width="1.8"/>
  <text x="350" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#7b341e">Docker DNS</text>
  <text x="350" y="120" text-anchor="middle" font-size="11" font-family="monospace" fill="#6b7280">127.0.0.11</text>
  <rect x="520" y="70" width="160" height="70" rx="8" fill="#fff" stroke="#475569" stroke-width="1.8"/>
  <text x="600" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#0f172a">db 컨테이너</text>
  <text x="600" y="120" text-anchor="middle" font-size="11" font-family="monospace" fill="#6b7280">172.18.0.3</text>
  <line x1="180" y1="92" x2="270" y2="92" stroke="#475569" stroke-width="1.8" marker-end="url(#ah-p)"/>
  <text x="225" y="85" text-anchor="middle" font-size="11" fill="#0f172a"><tspan font-weight="700">1.</tspan> db의 IP는?</text>
  <line x1="270" y1="118" x2="180" y2="118" stroke="#ff7849" stroke-width="1.8" stroke-dasharray="5,3" marker-end="url(#ah-o)"/>
  <text x="225" y="133" text-anchor="middle" font-size="11" fill="#7b341e"><tspan font-weight="700">2.</tspan> 172.18.0.3</text>
  <path d="M 100 140 L 100 195 L 600 195 L 600 140" fill="none" stroke="#475569" stroke-width="1.8" marker-end="url(#ah-p)"/>
  <rect x="265" y="183" width="170" height="22" rx="4" fill="#fff"/>
  <text x="350" y="198" text-anchor="middle" font-size="11" fill="#0f172a"><tspan font-weight="700">3.</tspan> 172.18.0.3 으로 요청</text>
</svg>
</div>

*그림 2-21. Docker DNS가 이름을 IP로 변환*
...
*그림 2-22. Ubuntu 컨테이너 안으로 들어간 상태*

프롬프트가 `root@...#` 모양으로 바뀌었습니다. 방금까지 호스트의 터미널이었는데 이제는 컨테이너 안의 쉘입니다.
...
<table style="width:100%; border-collapse:collapse;">
  <thead>
    <tr>
      <th style="width:15%; text-align:left;">용도</th>
      <th style="text-align:left;">명령</th>
      <th style="width:38%; text-align:left;">설명</th>
    </tr>
  </thead>
  <tbody>
    <tr><td style="white-space:nowrap;">위치 확인</td><td style="white-space:nowrap;"><strong>pwd</strong></td><td>현재 위치</td></tr>
    <tr><td style="white-space:nowrap;">이동</td><td style="white-space:nowrap;"><strong>cd &lt;경로&gt;</strong></td><td>폴더 이동</td></tr>
    <tr><td style="white-space:nowrap;">목록</td><td style="white-space:nowrap;"><strong>ls, ls -la</strong></td><td>파일/폴더 목록 (숨김 포함)</td></tr>
    <tr><td style="white-space:nowrap;">폴더 생성</td><td style="white-space:nowrap;"><strong>mkdir &lt;이름&gt;</strong></td><td>폴더 만들기</td></tr>
    <tr><td style="white-space:nowrap;">파일 생성</td><td style="white-space:nowrap;"><strong>touch &lt;이름&gt;</strong></td><td>빈 파일</td></tr>
    <tr><td style="white-space:nowrap;">복사</td><td style="white-space:nowrap;"><strong>cp &lt;원본&gt; &lt;사본&gt;</strong></td><td>파일 복사</td></tr>
    <tr><td style="white-space:nowrap;">이동/이름변경</td><td style="white-space:nowrap;"><strong>mv &lt;원본&gt; &lt;대상&gt;</strong></td><td>이동 또는 rename</td></tr>
    <tr><td style="white-space:nowrap;">삭제</td><td style="white-space:nowrap;"><strong>rm &lt;파일&gt;, rm -r &lt;폴더&gt;</strong></td><td>삭제</td></tr>
    <tr><td style="white-space:nowrap;">패키지 설치</td><td style="white-space:nowrap;"><strong>apt update &amp;&amp; apt install -y &lt;이름&gt;</strong></td><td>패키지 설치</td></tr>
    <tr><td style="white-space:nowrap;">프로세스</td><td style="white-space:nowrap;"><strong>ps -ef, kill &lt;PID&gt;</strong></td><td>실행 중 프로세스 / 종료</td></tr>
    <tr><td style="white-space:nowrap;">검색</td><td style="white-space:nowrap;"><strong>find &lt;경로&gt; -name &lt;이름&gt;</strong></td><td>파일 검색</td></tr>
    <tr><td style="white-space:nowrap;">로그</td><td style="white-space:nowrap;"><strong>tail -n &lt;수&gt; &lt;파일&gt;</strong></td><td>마지막 N줄</td></tr>
  </tbody>
</table>
...
<table style="width:100%; border-collapse:collapse;">
  <thead>
    <tr>
      <th style="width:8%; text-align:center;">단계</th>
      <th style="text-align:left;">동작</th>
      <th style="text-align:left;">키</th>
    </tr>
  </thead>
  <tbody>
    <tr><td style="text-align:center;">1</td><td>파일 열기/생성</td><td style="white-space:nowrap;"><strong>vim &lt;파일명&gt;</strong></td></tr>
    <tr><td style="text-align:center;">2</td><td>입력 모드</td><td style="white-space:nowrap;"><strong>i</strong></td></tr>
    <tr><td style="text-align:center;">3</td><td>일반 모드로</td><td style="white-space:nowrap;"><strong>ESC</strong></td></tr>
    <tr><td style="text-align:center;">4</td><td>저장 후 종료</td><td style="white-space:nowrap;"><strong>:wq</strong></td></tr>
  </tbody>
</table>

vim으로 간단한 파일을 만들어 봅니다.

```bash [터미널] 컨테이너 내부 - vim으로 파일 생성
vim test1.txt   # test1.txt 파일 생성
```

`i`를 눌러 입력 모드로 전환하고 내용을 작성한 뒤 `ESC` → `:wq`로 저장합니다.
...
**메인 프로세스**는 도커 컨테이너가 돌리는 중심 프로그램으로, 컨테이너 안에서 가장 먼저 실행되어 **프로세스 ID(PID) 1번**을 받습니다. 자동차가 엔진이 도는 동안에만 달릴 수 있듯, 컨테이너 역시 **이 메인 프로세스가 멈추면 그 즉시 함께 종료됩니다**.
<div class="svg-figure">
<svg viewBox="0 0 760 250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="컨테이너 안에서 가장 먼저 뜨는 프로세스가 PID 1 메인 프로세스인 구조">
<text x="380" y="30" text-anchor="middle" font-size="13" font-weight="700" fill="#1f2937">컨테이너 안에서 도는 중심 프로그램 = 메인 프로세스</text>
<rect x="170" y="62" width="420" height="158" rx="10" fill="#fff" stroke="#9ca3af" stroke-width="1.4" stroke-dasharray="5,3"/>
<text x="190" y="84" font-size="12" font-weight="600" fill="#6b7280">컨테이너</text>
<rect x="290" y="112" width="180" height="78" rx="8" fill="#fff4ed" stroke="#ff7849" stroke-width="1.8"/>
<text x="380" y="144" text-anchor="middle" font-size="14" font-weight="700" fill="#7b341e">메인 프로세스</text>
<text x="380" y="169" text-anchor="middle" font-size="12" font-family="monospace" fill="#7b341e">PID 1</text>
<text x="380" y="208" text-anchor="middle" font-size="11" fill="#6b7280">컨테이너 안에서 가장 먼저 뜨는 프로세스</text>
</svg>
</div>

*그림 2-28. 컨테이너 안에서 도는 중심 프로그램이 메인 프로세스입니다*

### 2.6.2 메인 프로세스에서 빠져나오기

`exit`를 입력했을 때 컨테이너가 종료된 상황을 한 번 더 재연해 보겠습니다. 컨테이너에 `dead`라는 이름을 붙여 실행한 뒤, 안에서 `exit`로 빠져나옵니다.

```bash [터미널] exit로 빠져나오는 시나리오
...
*그림 2-29. exit로 빠져나오면 컨테이너가 종료*

목록에 dead는 없습니다. **`exit`가 메인 프로세스를 종료하면서 컨테이너까지 함께 멈췄기 때문입니다.** 그런데 컨테이너를 빠져나오는 방법이 `exit`만 있는 것은 아닙니다.

`CTRL+P → CTRL+Q`를 누르면 메인 프로세스는 그대로 둔 채 터미널 연결만 끊을 수 있습니다. `alive`라는 이름으로 컨테이너를 실행한 뒤, 이 키로 빠져나옵니다.

```bash [터미널] CTRL+P → CTRL+Q로 빠져나오는 시나리오
...
<div class="terminal-log">
  ...
  <div class="tl-body">
    <div><span class="tl-key">root@17943f60b5cd:/#</span></div>
    <div><span class="tl-key">$</span> <span class="tl-str">docker ps</span></div>
    <div>CONTAINER ID   IMAGE    COMMAND       CREATED                  STATUS                 PORTS   NAMES</div>
...
*그림 2-30. CTRL+P → CTRL+Q로는 컨테이너가 유지*
...
<div class="svg-figure">
<svg viewBox="0 0 760 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="ubuntu 컨테이너의 메인 프로세스는 bash, nginx 컨테이너의 메인 프로세스는 웹 서버">
<text x="380" y="28" text-anchor="middle" font-size="13" font-weight="700" fill="#1f2937">이미지마다 메인 프로세스가 정해져 있다</text>
<rect x="60" y="64" width="290" height="190" rx="10" fill="#fff" stroke="#9ca3af" stroke-width="1.4" stroke-dasharray="5,3"/>
<text x="80" y="86" font-size="12" font-weight="600" fill="#6b7280">ubuntu 컨테이너</text>
<rect x="120" y="120" width="170" height="78" rx="8" fill="#fff4ed" stroke="#ff7849" stroke-width="1.8"/>
<text x="205" y="150" text-anchor="middle" font-size="13" font-weight="700" fill="#7b341e">bash</text>
<text x="205" y="174" text-anchor="middle" font-size="11" font-family="monospace" fill="#7b341e">메인 프로세스 · PID 1</text>
<text x="205" y="228" text-anchor="middle" font-size="11" fill="#6b7280">명령을 입력받는 셸</text>
<rect x="410" y="64" width="290" height="190" rx="10" fill="#fff" stroke="#9ca3af" stroke-width="1.4" stroke-dasharray="5,3"/>
<text x="430" y="86" font-size="12" font-weight="600" fill="#6b7280">nginx 컨테이너</text>
<rect x="470" y="120" width="170" height="78" rx="8" fill="#fff4ed" stroke="#ff7849" stroke-width="1.8"/>
<text x="555" y="150" text-anchor="middle" font-size="13" font-weight="700" fill="#7b341e">웹 서버</text>
<text x="555" y="174" text-anchor="middle" font-size="11" font-family="monospace" fill="#7b341e">메인 프로세스 · PID 1</text>
<text x="555" y="228" text-anchor="middle" font-size="11" fill="#6b7280">요청을 기다리는 데몬</text>
</svg>
</div>

*그림 2-32. 같은 PID 1 자리에 이미지마다 다른 프로그램이 메인 프로세스로 들어갑니다*
...
*그림 2-33. CMD를 sleep으로 바꾸면 유지*

이제 ubuntu가 목록에 남아 있습니다. 메인 프로세스가 bash에서, 터미널이 없어도 1000초 동안 할 일이 있는 sleep으로 바뀌었기 때문입니다. 이렇게 **기본 메인 프로세스를 바꾸는 설정을 CMD**라고 합니다.
...
<div class="terminal-log">
  ...
  <div class="tl-body">
    ...
    <div>d2b18acc2cf05a40644f0ca8536cb50a0ff560a1be0c9ce2fbf5ddbbba0e729c</div>
    <div><span class="tl-key">$</span> <span class="tl-str">docker ps</span></div>
    <div>CONTAINER ID   IMAGE    COMMAND       CREATED                  STATUS                 PORTS   NAMES</div>
...
이번에는 exec를 알아보겠습니다. exec는 **컨테이너 안에 새 프로세스를 실행**하는 방식입니다.
...
*그림 2-39. Tomcat 404 에러 화면*

*'연결은 된 거 같은데 왜 404 에러가 뜨지?'*

Tomcat은 루트 주소로 접속하면 `webapps/ROOT/` 폴더의 index.html을 기본 페이지로 응답합니다. 그런데 Docker Hub에서 받은 이미지는 `webapps/`가 비어 있어, 이 index.html이 없으니 404가 뜹니다.

그래서 `webapps/ROOT/`에 index.html을 직접 만들어 브라우저에서 응답되도록 해 보겠습니다.

```bash [터미널] Tomcat 컨테이너 접속과 설정 수정
...
<div class="terminal-log">
  ...
  <div class="tl-body">
    ...
    <div>sha256:0f8181585ca9e7f2b68c623f0ce6d64f5fddfeb19076c7c0e82e55ca4629cfbb</div>
  </div>
</div>

*그림 2-41. 이미지 커밋 완료 화면*

저장된 이미지가 목록에 잘 들어갔는지 확인합니다.

```bash [터미널] 로컬 이미지 목록 확인
...
*그림 2-42. 로컬 이미지 목록에 새 이미지 추가 확인*
...
```bash [터미널] Docker Hub 로그인과 푸시
docker login                     # Docker Hub 로그인
docker push coderyu5523/tomcat   # 로컬 이미지를 Hub로 업로드
```
...
첫 번째 방식은 **호스트 PC의 특정 폴더**를 **컨테이너 내부의 경로**와 연결하는 **바인드 마운트(Bind Mount)** 입니다. USB를 컴퓨터에 꽂으면 그 안의 파일을 그대로 볼 수 있듯, 컨테이너도 호스트 PC의 폴더를 꽂아서 쓰는 방식입니다.

<div class="svg-figure">
<svg viewBox="0 0 760 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="바인드 마운트 — 호스트 PC의 사용자 지정 폴더와 컨테이너 안 경로를 직접 연결한 구조">
  <defs>
    <marker id="bm-p" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#dc2626"/></marker>
  </defs>
  <text x="380" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#1f2937">바인드 마운트 — 호스트 폴더와 컨테이너 경로 직접 연결</text>
  <rect x="20" y="50" width="280" height="160" rx="8" fill="#fff" stroke="#475569" stroke-width="1.4" stroke-dasharray="6,4"/>
  <text x="34" y="70" font-size="11" font-weight="700" fill="#475569">호스트 PC</text>
  <rect x="50" y="90" width="220" height="100" rx="6" fill="#fff" stroke="#94a3b8" stroke-width="1.2" stroke-dasharray="4,3"/>
  <text x="160" y="108" text-anchor="middle" font-size="11" font-weight="600" fill="#475569">사용자 지정 경로</text>
  <!-- 큰 노란 폴더 아이콘 (사용자 폴더) -->
  <g transform="translate(62, 125)">
    <path d="M 0 8 L 14 8 L 19 3 L 50 3 L 50 48 L 0 48 Z" fill="#fbbf24" stroke="#7b341e" stroke-width="1.8"/>
    <rect x="4" y="16" width="42" height="3" fill="#fde68a"/>
    <rect x="4" y="24" width="42" height="3" fill="#fde68a"/>
  </g>
  <rect x="125" y="128" width="138" height="22" rx="3" fill="#fff" stroke="#475569" stroke-width="1.2"/>
  <text x="194" y="143" text-anchor="middle" font-size="11" font-family="monospace" fill="#0f172a">/c/app/bind</text>
  <rect x="140" y="158" width="108" height="22" rx="3" fill="#fff" stroke="#475569" stroke-width="1.2"/>
  <text x="194" y="173" text-anchor="middle" font-size="11" font-family="monospace" fill="#0f172a">a.txt</text>
  <rect x="460" y="50" width="280" height="160" rx="8" fill="#fff" stroke="#ff7849" stroke-width="1.4" stroke-dasharray="6,4"/>
  <text x="474" y="70" font-size="11" font-weight="700" fill="#7b341e">컨테이너 (Ubuntu)</text>
  <rect x="490" y="90" width="220" height="100" rx="6" fill="#fff" stroke="#fdba74" stroke-width="1.2" stroke-dasharray="4,3"/>
  <text x="600" y="110" text-anchor="middle" font-size="11" font-weight="600" fill="#7b341e">컨테이너 내부 경로</text>
  <rect x="520" y="125" width="160" height="22" rx="3" fill="#fff" stroke="#475569" stroke-width="1.2"/>
  <text x="600" y="140" text-anchor="middle" font-size="11" font-family="monospace" fill="#0f172a">/app/bind</text>
  <rect x="540" y="155" width="120" height="22" rx="3" fill="#fff" stroke="#475569" stroke-width="1.2"/>
  <text x="600" y="170" text-anchor="middle" font-size="11" font-family="monospace" fill="#0f172a">a.txt</text>
  <line x1="305" y1="130" x2="455" y2="130" stroke="#dc2626" stroke-width="2" marker-end="url(#bm-p)"/>
  <line x1="455" y1="148" x2="305" y2="148" stroke="#dc2626" stroke-width="2" marker-end="url(#bm-p)"/>
  <text x="380" y="115" text-anchor="middle" font-size="12" font-weight="700" fill="#b91c1c">바인드 마운트</text>
  <text x="380" y="172" text-anchor="middle" font-size="10" font-style="italic" fill="#b91c1c">직접 연결</text>
</svg>
</div>

*그림 2-45. 호스트 폴더와 컨테이너 경로가 같은 데이터를 바라보도록 묶인 상태*
...
<div class="terminal-log">
  ...
  <div class="tl-body">
    <div><span class="tl-key">$</span> <span class="tl-str">docker run -it --mount type=bind,src=/c/app/bind,dst=/app/bind ubuntu</span></div>
    <div>root@a3f1e2b4c5d6:/#</div>
  </div>
</div>

*그림 2-46. 바인드 마운트로 ubuntu 실행*
...
*그림 2-47. 호스트 PC에서 같은 파일이 보이는 것을 확인*
...
<svg viewBox="0 0 760 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="볼륨 마운트 — Docker가 관리하는 호스트 PC 안 저장 공간을 컨테이너에 연결한 구조">
  <defs>
    <marker id="vm-p" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#dc2626"/></marker>
  </defs>
  <text x="380" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#1f2937">볼륨 마운트 — Docker가 관리하는 저장 공간을 컨테이너에 연결</text>
  <rect x="20" y="50" width="280" height="160" rx="8" fill="#fff" stroke="#475569" stroke-width="1.4" stroke-dasharray="6,4"/>
  <text x="34" y="70" font-size="11" font-weight="700" fill="#475569">호스트 PC</text>
  <rect x="50" y="90" width="220" height="100" rx="6" fill="#fff4ed" stroke="#ff7849" stroke-width="1.4"/>
  <text x="160" y="108" text-anchor="middle" font-size="11" font-weight="700" fill="#7b341e">Docker 내부 저장소</text>
  <!-- 큰 파란 실린더 아이콘 (Docker 저장소) -->
  <g transform="translate(88, 132)">
    <ellipse cx="0" cy="0" rx="22" ry="6" fill="#fff" stroke="#1d63ed" stroke-width="1.8"/>
    <path d="M -22 0 L -22 36 Q -22 42 0 42 Q 22 42 22 36 L 22 0" fill="#fff" stroke="#1d63ed" stroke-width="1.8"/>
    <ellipse cx="0" cy="14" rx="22" ry="5" fill="none" stroke="#1d63ed" stroke-width="0.8" opacity="0.55"/>
    <ellipse cx="0" cy="26" rx="22" ry="5" fill="none" stroke="#1d63ed" stroke-width="0.8" opacity="0.55"/>
  </g>
  <text x="194" y="138" text-anchor="middle" font-size="10" font-family="monospace" fill="#7b341e">/var/lib/docker/volumes/</text>
  <rect x="125" y="155" width="138" height="24" rx="3" fill="#fff" stroke="#ff7849" stroke-width="1.2"/>
  <text x="194" y="171" text-anchor="middle" font-size="11" font-family="monospace" fill="#7b341e">metacoding-volume</text>
  <rect x="460" y="50" width="280" height="160" rx="8" fill="#fff" stroke="#ff7849" stroke-width="1.4" stroke-dasharray="6,4"/>
  <text x="474" y="70" font-size="11" font-weight="700" fill="#7b341e">컨테이너 (Ubuntu)</text>
  <rect x="490" y="90" width="220" height="100" rx="6" fill="#fff" stroke="#fdba74" stroke-width="1.2" stroke-dasharray="4,3"/>
  <text x="600" y="110" text-anchor="middle" font-size="11" font-weight="600" fill="#7b341e">컨테이너 내부 경로</text>
  <rect x="520" y="125" width="160" height="22" rx="3" fill="#fff" stroke="#475569" stroke-width="1.2"/>
  <text x="600" y="140" text-anchor="middle" font-size="11" font-family="monospace" fill="#0f172a">/app/volume</text>
  <rect x="540" y="155" width="120" height="22" rx="3" fill="#fff" stroke="#475569" stroke-width="1.2"/>
  <text x="600" y="170" text-anchor="middle" font-size="11" font-family="monospace" fill="#0f172a">b.txt</text>
  <line x1="305" y1="130" x2="455" y2="130" stroke="#dc2626" stroke-width="2" marker-end="url(#vm-p)"/>
  <line x1="455" y1="148" x2="305" y2="148" stroke="#dc2626" stroke-width="2" marker-end="url(#vm-p)"/>
  <text x="380" y="115" text-anchor="middle" font-size="12" font-weight="700" fill="#b91c1c">볼륨 마운트</text>
  <text x="380" y="172" text-anchor="middle" font-size="10" font-style="italic" fill="#b91c1c">Docker 관리</text>
</svg>
</div>

*그림 2-48. Docker 엔진이 관리하는 내부 저장 공간에 데이터가 저장되는 구조*
