...
<div class="librarian-scene">
  <div class="ls-grid">
    ...
    <div class="ls-actor center">
      ...
      <div class="ls-note">질문에 맞는 책을 서가에서 골라<br>방문자에게 건네주는 역할</div>
    </div>
    <div class="ls-bridge">
    ...
    <div class="ls-actor">
      <div class="ls-icon shelf"><span></span><span></span><span></span><span></span><span></span><span></span></div>
  ...
  <div class="lrs-paths">
    <div class="lrs-path bad">
      <div class="lrs-path-head">
        ...
        <span class="lrs-dim">근거 없음 · 환각 위험</span>
      </div>
      <div class="lrs-flow">
    ...
    <div class="lrs-path good">
      <div class="lrs-path-head">
        ...
        <span class="lrs-dim">근거 있음 · 출처 포함</span>
      </div>
      <div class="lrs-flow">
...
<div class="caption">그림 1-8. 같은 질문에서 LLM 단독은 점선(짧은 경로)을 따라 환각 답변에, RAG는 실선(검색 단계 포함)을 따라 출처 답변에 도달합니다</div>
