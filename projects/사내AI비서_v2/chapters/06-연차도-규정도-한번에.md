...
*한 번의 질문으로 AI 비서가 필요한 도구를 알아서 골라 정보를 조합해준다.*
...
*CH06 전체 흐름입니다. 질문이 AI 비서(QueryRouter)를 거쳐 분류되고, 에이전트가 도구를 호출하여 답변을 생성합니다.*
...
*파란색이 이번 실습에서 만드는 부분입니다. 질문을 정형/비정형/혼합으로 분류하는 AI 비서의 질문 분류기를 만듭니다.*
