...
> 기본 환경(Python 3.12, Docker)이 없다면 **교육자료**를 먼저 확인해 주시길 권장합니다.
...
> **팁: 코드가 궁금하다면**
> `code/ex02/app/` 폴더에 전체 소스가 있습니다. FastAPI + psycopg2 + Pydantic 조합으로 만들어져 있습니다. 이 책의 핵심 주제가 아니므로 상세한 코드 설명은 생략하지만, 관심이 있으시다면 언제든 직접 읽어보시는 것을 권장합니다.
