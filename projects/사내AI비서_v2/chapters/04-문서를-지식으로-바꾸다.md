...
chunker와 store를 채웠으면 이제 **파이프라인을 조립**합니다. `ex04/src/main.py`를 열어 세 함수의 TODO를 채워줍니다.
...
파이프라인을 돌렸으면 이제 **검색이 작동하는지 직접 확인해 보겠습니다.** `ex04/src/cli_search.py`를 열어 두 함수의 TODO를 채워줍니다.
