...
# docs_dir(data/docs/) 안의 PDF/DOCX/XLSX를 한꺼번에 파싱
results = extract_all_from_directory(docs_dir)
# 파싱 결과를 data/markdown/에 .md 파일로 저장 (눈으로 확인용)
