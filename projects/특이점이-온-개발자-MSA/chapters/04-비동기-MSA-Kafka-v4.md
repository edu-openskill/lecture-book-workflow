...
- **컨슈머 그룹과 `groupId`**: 실습에서 `@KafkaListener`에 적는 `groupId`가 바로 그 그룹 이름이며, 4.4.3에서 코드로 직접 다룹니다.
...
<div class="svg-figure">
<svg viewBox="260 30 1320 560" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="롤백 1단계: orchestrator가 increase-product-command를 발행하고 상품 서비스가 받아 재고를 복구">
  <defs>
   <marker id="rb1a" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#4f46e5"/></marker>
   <marker id="rb1b" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#3730a3"/></marker>
  </defs>
  <text x="680" y="50" text-anchor="middle" font-size="16" font-weight="700" fill="#0f172a">롤백 1단계 — 재고 복구 명령 발행 → 상품 서비스 수신</text>
  <rect x="345" y="64" width="170" height="70" rx="8" fill="#fff" stroke="#cbd5e1" stroke-width="1.4"/>
  <text x="430" y="94" text-anchor="middle" font-size="16" font-weight="700" fill="#94a3b8">Order</text>
  ...
  <text x="660" y="94" text-anchor="middle" font-size="16" font-weight="700" fill="#3730a3">Product</text>
  <text x="660" y="116" text-anchor="middle" font-size="12" fill="#3730a3">:8082 상품</text>
  ...
  <rect x="280" y="250" width="780" height="22" fill="#ff7849"/>
  <text x="670" y="265" text-anchor="middle" font-size="11" font-weight="700" fill="#fff">Kafka — 재고 복구 명령이 발행됨</text>
  <rect x="575" y="290" width="170" height="42" rx="3" fill="#ffedd5" stroke="#ff7849" stroke-width="1.8"/>
  <path d="M575 290 L660 311 L745 290" fill="none" stroke="#ff7849" stroke-width="1.4"/>
  <text x="660" y="350" text-anchor="middle" font-size="9.5" font-weight="700" fill="#9a3412">increase-product-command (보상)</text>
  <circle cx="727" cy="298" r="10" fill="#ff7849"/>
  <text x="727" y="302" text-anchor="middle" font-size="11" font-weight="700" fill="#fff">1</text>
  <rect x="300" y="480" width="760" height="88" rx="10" fill="#c7d2fe" stroke="#4f46e5" stroke-width="2.4"/>
  <text x="680" y="514" text-anchor="middle" font-size="20" font-weight="700" fill="#312e81">Orchestrator</text>
  <text x="680" y="538" text-anchor="middle" font-size="12" fill="#312e81">실패 감지 후 재고 복구 명령 발행</text>
  <line x1="660" y1="478" x2="660" y2="372" stroke="#4f46e5" stroke-width="2.6" marker-end="url(#rb1a)"/>
  <text x="682" y="429" text-anchor="start" font-size="13" font-weight="700" fill="#4f46e5">1. 재고 복구 명령 발행</text>
  <line x1="660" y1="248" x2="660" y2="136" stroke="#3730a3" stroke-width="2.6" stroke-dasharray="5,3" marker-end="url(#rb1b)"/>
  <text x="682" y="200" text-anchor="start" font-size="13" font-weight="700" fill="#3730a3">2. 상품 서비스가 수신해 재고 복구</text>
  <rect x="1090" y="40" width="460" height="510" rx="10" fill="#fffdf5" stroke="#e7d9a8" stroke-width="1.5"/>
  <line x1="1132" y1="40" x2="1132" y2="550" stroke="#f0e6c8" stroke-width="1.3"/>
  <text x="1146" y="84" font-size="22" font-weight="700" fill="#9a3412">롤백 1단계</text>
  <text x="1146" y="124" font-size="20" font-weight="700" fill="#0f172a">1. 재고 복구 명령 발행</text>
  <text x="1146" y="158" font-size="18" font-weight="400" fill="#475569">오케스트레이터가 실패를 감지해</text>
  <text x="1146" y="185" font-size="18" font-weight="400" fill="#475569">재고 복구 명령을 카프카에</text>
  <text x="1146" y="212" font-size="18" font-weight="400" fill="#475569">발행합니다.</text>
  <text x="1146" y="252" font-size="20" font-weight="700" fill="#0f172a">2. 상품 서비스가 수신해 재고 복구</text>
  <text x="1146" y="286" font-size="18" font-weight="400" fill="#475569">상품 서비스가 그 토픽을 구독하고</text>
  <text x="1146" y="313" font-size="18" font-weight="400" fill="#475569">있다가 메시지를 받아 차감했던</text>
  <text x="1146" y="340" font-size="18" font-weight="400" fill="#475569">재고를 원복합니다.</text>
</svg>
</div>

*그림 4-12. 롤백 1단계 — 재고 복구*

<div class="svg-figure">
<svg viewBox="260 30 1320 560" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="롤백 2단계: orchestrator가 cancel-order-command를 발행하고 주문 서비스가 받아 주문을 CANCELLED로 변경">
  <defs>
   <marker id="rb2a" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#4f46e5"/></marker>
   <marker id="rb2b" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#3730a3"/></marker>
  </defs>
  <text x="680" y="50" text-anchor="middle" font-size="16" font-weight="700" fill="#0f172a">롤백 2단계 — 주문 취소 명령 발행 → 주문 서비스 수신</text>
  <rect x="345" y="64" width="170" height="70" rx="8" fill="#eef2ff" stroke="#4f46e5" stroke-width="1.8"/>
  <text x="430" y="94" text-anchor="middle" font-size="16" font-weight="700" fill="#3730a3">Order</text>
  ...
  <rect x="280" y="250" width="780" height="120" rx="9" fill="#fff4ed" stroke="#ff7849" stroke-width="2"/>
  <rect x="280" y="250" width="780" height="22" fill="#ff7849"/>
  <text x="670" y="265" text-anchor="middle" font-size="11" font-weight="700" fill="#fff">Kafka — 주문 취소 명령이 발행됨</text>
  <rect x="345" y="290" width="170" height="42" rx="3" fill="#fff" stroke="#ff7849" stroke-width="1"/>
  <path d="M345 290 L430 311 L515 290" fill="none" stroke="#ff7849" stroke-width="0.8"/>
  <text x="430" y="350" text-anchor="middle" font-size="9.5" font-weight="400" fill="#cbd5e1">increase-product-command</text>
  <rect x="575" y="290" width="170" height="42" rx="3" fill="#ffedd5" stroke="#ff7849" stroke-width="1.8"/>
  <path d="M575 290 L660 311 L745 290" fill="none" stroke="#ff7849" stroke-width="1.4"/>
  <text x="660" y="350" text-anchor="middle" font-size="9.5" font-weight="700" fill="#9a3412">cancel-order-command (보상)</text>
  <circle cx="727" cy="298" r="10" fill="#ff7849"/>
  <text x="727" y="302" text-anchor="middle" font-size="11" font-weight="700" fill="#fff">1</text>
  <rect x="300" y="480" width="760" height="88" rx="10" fill="#c7d2fe" stroke="#4f46e5" stroke-width="2.4"/>
  <text x="680" y="514" text-anchor="middle" font-size="20" font-weight="700" fill="#312e81">Orchestrator</text>
  <text x="680" y="538" text-anchor="middle" font-size="12" fill="#312e81">재고 복구 후 주문 취소 명령 발행</text>
  <line x1="660" y1="478" x2="660" y2="372" stroke="#4f46e5" stroke-width="2.6" marker-end="url(#rb2a)"/>
  <text x="682" y="429" text-anchor="start" font-size="13" font-weight="700" fill="#4f46e5">1. 주문 취소 명령 발행</text>
  <line x1="660" y1="248" x2="430" y2="136" stroke="#3730a3" stroke-width="2.6" stroke-dasharray="5,3" marker-end="url(#rb2b)"/>
  <text x="555" y="200" text-anchor="middle" font-size="13" font-weight="700" fill="#3730a3">2. 주문 서비스가 수신해 CANCELLED 처리</text>
  <rect x="1090" y="40" width="460" height="510" rx="10" fill="#fffdf5" stroke="#e7d9a8" stroke-width="1.5"/>
  <line x1="1132" y1="40" x2="1132" y2="550" stroke="#f0e6c8" stroke-width="1.3"/>
  <text x="1146" y="84" font-size="22" font-weight="700" fill="#9a3412">롤백 2단계</text>
  <text x="1146" y="124" font-size="20" font-weight="700" fill="#0f172a">1. 주문 취소 명령 발행</text>
  <text x="1146" y="158" font-size="18" font-weight="400" fill="#475569">오케스트레이터가 주문 취소 명령을</text>
  <text x="1146" y="185" font-size="18" font-weight="400" fill="#475569">카프카에 발행합니다.</text>
  <text x="1146" y="225" font-size="20" font-weight="700" fill="#0f172a">2. 주문 서비스가 수신해 CANCELLED</text>
  <text x="1146" y="259" font-size="18" font-weight="400" fill="#475569">주문 서비스가 그 토픽을 구독하고</text>
  <text x="1146" y="286" font-size="18" font-weight="400" fill="#475569">있다가 메시지를 받아 주문 상태를</text>
  <text x="1146" y="313" font-size="18" font-weight="400" fill="#475569">CANCELLED로 변경합니다.</text>
</svg>
</div>

*그림 4-13. 롤백 2단계 — 주문 취소*
...
이 Producer는 `createOrder`가 호출합니다. 챕터 2에서 상품·배달을 직접 호출하고 실패에 대비해 보상까지 떠안던 그 메서드는, 이제 주문을 저장하고 이 이벤트를 발행한 뒤 끝납니다. 재고 차감·배달 생성·실패 복구는 전부 orchestrator로 넘어가, 4.1에서 본 동기 직접 호출이 이 메서드에서 사라집니다.
...
재고 차감 결과를 받는 `productDecreased`, 배달 생성 결과를 받는 `deliveryCreated`도 **똑같은 구조**입니다. 결과 이벤트를 구독해, 성공이면 다음 명령을, 실패면 보상(재고 복구·주문 취소) 명령을 발행합니다(그림 4-8~4-11, 실패 흐름은 그림 4-12~4-13). 전체 코드는 GitHub에서 확인하세요.
...
### 4.4.3 구독 - 토픽을 듣고 있다가 받는다

받는 쪽은 메서드에 `@KafkaListener`를 붙이고 토픽 이름과 그룹 이름을 적습니다. 그 토픽에 메시지가 들어오면 이 메서드가 자동으로 실행됩니다. 방금 발행한 '주문 생성 이벤트'의 다음 단계인 재고 차감을 예로 봅니다. 상품 서비스가 '재고 차감 명령'을 구독해 재고를 줄이고, 그 결과를 다시 '재고 차감 이벤트'로 발행합니다.
...
`@KafkaListener(토픽, 그룹)` 메서드 하나가 구독의 전부입니다. 상품 서비스는 명령을 받아 재고만 줄이고, 성공·실패를 `success` 값에 담아 결과 이벤트로 돌려줄 뿐입니다. 다음에 무엇을 할지는 모릅니다. 그 판단은 orchestrator의 몫입니다.

:::note
**`groupId`는 컨슈머 그룹 이름입니다.** 같은 그룹끼리는 메시지를 나눠 받고, 다른 그룹이면 같은 메시지를 각각 받습니다.
:::

각 서비스 코드는 이 발행·구독 패턴에 토픽 이름만 바꿔 끼운 것입니다. 그래서 코드를 일일이 보지 않아도, 어떤 서비스가 무슨 토픽을 구독해 무엇을 하고 무엇을 발행하는지만 알면 전체가 보입니다.
...
챕터 3에서 6개 서비스를 Kubernetes에 올렸습니다. Kafka를 도입하면서 더해지는 건 둘입니다. Kafka 브로커 한 대와 orchestrator 한 개. 그리고 기존 order·product·delivery는 Kafka가 어디 있는지 알아야 하므로 ConfigMap에 주소 한 줄을 더합니다. 챕터 3 배포에서 바뀌는 부분은 이 세 가지가 전부입니다.

| 구분 | K8s 리소스 | 역할 |
|---|---|---|
| 신규 | `kafka-deploy.yml` + `kafka-service.yml` | KRaft 모드 단일 브로커. `kafka-service:9092`로 노출 |
| 신규 | `orchestrator-deploy.yml` + `orchestrator-configmap.yml` | 워크플로우 조율 서비스. REST가 없어 Service는 두지 않음 |
| 변경 | order·product·delivery ConfigMap | `SPRING_KAFKA_BOOTSTRAP_SERVERS: kafka-service:9092` 한 줄 추가 |

기존 Kafka는 ZooKeeper가 따로 필요했지만, **KRaft 모드**는 Kafka 컨테이너 하나로 동작합니다. `confluentinc/cp-kafka:7.5.0` 이미지를 단일 브로커로 띄웁니다.

:::note
실습은 **단일 브로커**로 띄웁니다. 실무에서는 여러 대를 하나의 클러스터로 묶어 같은 메시지를 복제해, 한 대가 죽어도 데이터가 남도록 합니다.
:::

각 서비스는 `kafka-service:9092` 하나로 Kafka에 접근합니다. 클라이언트의 `SPRING_KAFKA_BOOTSTRAP_SERVERS`와 브로커의 `KAFKA_ADVERTISED_LISTENERS` 값이 같아야 연결됩니다.
...
<svg viewBox="0 0 1000 460" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="KAFKA_ADVERTISED_LISTENERS: 4개의 클라이언트 서비스가 kafka-service:9092 주소로 브로커에 접근">
  ...
  <text x="650" y="180" font-size="11" font-weight="600" fill="#4f46e5" font-family="JetBrains Mono, monospace">SPRING_KAFKA_BOOTSTRAP_SERVERS</text>
  ...
  <text x="500" y="425" text-anchor="middle" font-size="12" fill="#475569">클라이언트의 SPRING_KAFKA_BOOTSTRAP_SERVERS 값은 브로커의 ADVERTISED_LISTENERS 값과 일치해야 합니다.</text>
</svg>
</div>
...
| 환경변수 | 값 | 역할 |
|---|---|---|
| `CLUSTER_ID` | `AbijZYk0QOm5p852kOMSIg` | 클러스터 식별 UUID |
| `KAFKA_PROCESS_ROLES` | `broker,controller` | KRaft — 브로커·컨트롤러 겸용 |
| `KAFKA_ADVERTISED_LISTENERS` | `PLAINTEXT://kafka-service:9092` | 클라이언트 접근 주소 (ConfigMap의 SPRING_KAFKA_BOOTSTRAP_SERVERS와 일치) |
| `KAFKA_CONTROLLER_QUORUM_VOTERS` | `1@localhost:9093` | 단일 브로커 — 자기 자신만 등록 |
...
이번에는 product-service를 일부러 꺼봤습니다. 4.1에서 상품 서버가 잠깐 죽자 주문이 통째로 무너졌던 그 자리에, 이제 주문 요청이 그대로 들어왔습니다. 메시지는 Kafka 토픽에 쌓였고, product-service Pod이 다시 살아나자 밀려 있던 명령이 순서대로 처리됐습니다. order-service의 try/catch 보상 블록은 사라졌고, 그 자리에는 `orderEventProducer.publishOrderCreated(...)` 한 줄만 남았습니다. 두 서비스가 강하게 결합되어 있던 문제가 해결됐습니다.
