...
**선배**: "지금 구조는 결합도가 너무 높아서 그래요. 해결하려면 두 가지만 기억하면 돼요.
...
둘째는 **도메인 주도 개발(DDD)** 이에요. 핵심 비즈니스 로직을 외부 환경에 두지 말고 도메인 내부에 단단하게 모아 둬야 해요. 그래야 외부가 어떻게 바뀌든 흔들리지 않고, 테스트도 도메인만 독립적으로 깔끔하게 끝낼 수 있어요."
