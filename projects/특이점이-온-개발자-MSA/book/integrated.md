...
![백화점 - 모든 매장이 한 건물에](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap01-1.png)
...
![모놀리식 쇼핑몰](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap01-2.png)
...
![개별 상점 - 각 매장이 독립된 건물](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap01-3.png)
...
![마이크로서비스 쇼핑몰](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap01-4.png)
...
![챕터 2~3 아키텍처 — 동기 REST 통신](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-1-5.png)
...
![챕터 4~5 아키텍처 — Kafka 비동기 통신](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-1-6.png)
...
![서비스별 독립 데이터베이스](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap01-5.png)
...
![Choreography Saga — 서비스 간 직접 호출과 보상](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-1-8.png)
...
![Orchestration Saga — 오케스트레이터가 흐름을 조율](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-1-9.png)
...
![이 책의 학습 흐름](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap01-6.png)
*그림 1-10: 이 책의 학습 흐름*
...
![주문 성공 흐름](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-2-1.png)
*그림 2-1: 주문 성공 흐름*

### 2.6.7 주문 실패 시

![주문 실패 시 보상 트랜잭션 흐름](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-2-2.png)
...
![docker compose up](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-1.png)
...
![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-2.png)
*그림 2-4: Hoppscotch 화면*

![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-3.png)
...
![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-4.png)
...
![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-5.png)
*그림 2-7: Bearer 토큰 설정*
...
![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-6.png)
...
![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-7.png)
*그림 2-9: 재고 감소 확인*
...
![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-8.png)
*그림 2-10: 배달 생성 확인*
...
![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-9.png)
...
![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-10.png)
...
![Hoppscotch](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap02-11.png)
*그림 2-13: 재고 원복 확인*
...
![전원 어댑터](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap03-1.png)
*그림 3-1: UseCase 인터페이스 — 전원 어댑터 비유*

코드로 옮기면 이렇게 됩니다.

![유즈케이스](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap03-2.png)
...
![Kubernetes 리소스 관계](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-3-3.png)
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap03-3.png)
*그림 3-4: Minikube 시작*
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap03-4.png)
*그림 3-5: 이미지 빌드 결과*
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap03-5.png)
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap03-6.png)
*그림 3-7: Pod 상태 확인*
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap03-8.png)
*그림 3-8: 주문 결과 확인*
...
![동기비동기](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-1-1.png)
*그림 4-1: 동기 vs 비동기 통신*
...
![메시지 큐](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-1-2.png)
*그림 4-2: 메시지 큐 개념*
...
![컨슈머 그룹](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-2-1.png)
*그림 4-3: 컨슈머 그룹*
...
![Orchestration Saga 구조](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-orchestra.png)
...
![주문 성공 흐름](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-4-5.png)
...
![주문 실패 시 롤백 흐름](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-4-6.png)
...
![1단계: 주문 생성 이벤트 수신](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-4-7.png)
...
![2단계: 재고 차감 결과 수신](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-4-8.png)
...
![3단계: 배달 생성 결과 수신](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-4-9.png)
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-1.png)
*그림 4-10: Kafka 및 서비스 배포 실행*
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-2.png)
*그림 4-11: Pod 상태 확인 (kubectl get pods)*
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-4.png)
*그림 4-12: 주문 생성 응답 (PENDING 상태)*
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-5.png)
*그림 4-13: 주문 완료 확인 (COMPLETED 상태)*
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-6.png)
*그림 4-14: 품절 상품 주문 요청*
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap04-7.png)
*그림 4-15: orchestrator 롤백 로그 확인*
...
![폴링과 웹소켓](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-polling.png)
...
![챕터 4의 배달 흐름](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-5-2.png)
...
![챕터 5의 배달 흐름](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\fig-5-3.png)
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-1.png)
*그림 5-4: Pod 상태 확인*
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-3.png)
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-4.png)
*그림 5-6: 토큰 입력 후 주문하기 버튼 클릭*

브라우저 `F12` - `Console`에서 WebSocket이 연결됨을 확인할 수 있습니다.

![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-5.png)
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-6.png)
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-7.png)
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-8.png)
...
![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-9.png)
*그림 5-11: 주문 조회 결과 — COMPLETED 상태*

주문이 완료되면 WebSocket이 클라이언트에게 주문 완료 메시지를 전송합니다.
WebSocket 응답을 수신하면 클라이언트 화면이 주문 완료 상태로 변경됩니다.

![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-10.png)
*그림 5-12: WebSocket 알림 수신 — 클라이언트 화면에 주문 완료 표시*

브라우저의 Console 창에서 WebSocket이 응답한 메시지 로그를 확인할 수 있습니다.

![minikube](C:\study\book\book-workflow\projects\특이점이-온-개발자-MSA\chapters\images\chap05-11.png)
