...
#v(paragraph-gap)
#emph[일단 자바부터 깔자. MySQL도 깔고. 그건 해봤으니까.]
...
#v(paragraph-gap)
\[실습 순서들 다이어그램을 제거 하고 목록으로 작성하기\] #auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/diagram/01_exercise-flow.png", max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/gemini/01_docker-image-container.png", alt: [Dockerfile에서 이미지를 만들고, 이미지에서 컨테이너를 실행하는 흐름], max-width: 0.6)
...
#v(paragraph-gap)
#emph[\[이미지 누락: Spring Boot 서버가 8080 포트에서 시작된 로그\]]
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/gemini/02_docker-workflow.png", alt: [Dockerfile 작성부터 브라우저 접속까지의 전체 흐름], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/diagram/02_exercise-flow.png", alt: [이번 챕터의 실습 흐름], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/02_create-app-click.png", alt: [앱 추가하기 버튼 위치], max-width: 0.6)

#v(paragraph-gap)
앱 이름을 입력하고 저장합니다. 이름은 자유롭게 지으면 됩니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/03_create-app-form.png", alt: [앱 이름 입력 후 저장], max-width: 0.6)

#v(paragraph-gap)
생성된 앱을 클릭해서 대시보드로 이동합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/04_app-dashboard.png", alt: [앱 대시보드 -- 여기서부터 설정을 시작한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/05_login-activate-oidc.png", alt: [카카오 로그인 사용 설정 ON + OpenID Connect 활성화 -- 두 항목 모두 ON이면 성공이다], max-width: 0.6)

==== 3단계 -- 동의항목 설정

#strong[제품설정 \> 카카오 로그인 \> 동의항목] 으로 이동합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/06_consent-items.png", alt: [동의항목 페이지 -- 개인정보 항목 목록이 표시된다], max-width: 0.6)

#v(paragraph-gap)
#strong[닉네임] 항목의 #strong[설정] 을 클릭합니다. 동의 단계를 #strong[필수 동의] 로 변경하고 저장합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/07_nickname-consent-setting.png", alt: [닉네임 동의 단계를 필수 동의로 변경], max-width: 0.6)

#v(paragraph-gap)
저장 후 닉네임 상태가 #strong[필수 동의] 로 바뀌었는지 확인합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/08_consent-items-done.png", alt: [닉네임이 필수 동의로 변경된 상태], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/10_redirect-uri.png", alt: [Redirect URI 등록 -- 카카오 로그인 완료 후 되돌아올 우리 서버 주소], max-width: 0.6)

==== 5단계 -- REST API 키 확인

왼쪽 메뉴에서 #strong[앱 설정 \> 앱 키] 로 이동합니다. #strong[REST API 키] 를 복사해서 메모장에 저장합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/09_platform-keys.png", alt: [앱 키 페이지 -- REST API 키를 복사한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/setup/11_client-secret.png", alt: [Client Secret 발급 -- 활성화 상태가 사용함이면 성공이다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/gemini/02a_oauth-authorization-code-grant.png", alt: [그림 2-2a: 인가 코드 발급 --- 사용자가 카카오에 동의하면 인가 코드가 서버로 전달된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/gemini/02b_oauth-token-exchange.png", alt: [그림 2-2b: 토큰 교환 --- 인가 코드로 Access Token을 받고, 사용자 정보를 조회한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/terminal/03_kakao-consent-screen.png", alt: [카카오 로그인 동의 화면 -- 닉네임 제공에 동의하면 인가 코드가 발급된다. 이 화면이 보이면 리다이렉트까지 성공이다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/terminal/04_access-token-exchange.png", alt: [Access Token 교환 성공 -- 터미널에 accessToken, refreshToken 등이 출력되면 토큰 교환이 정상 동작하는 것이다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/gemini/05a_oidc-id-token-issue.png", alt: [그림 2-5a: ID Token 발급 --- scope에 openid를 추가하면 ID Token이 함께 응답된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/gemini/05b_oidc-jwks-verification.png", alt: [그림 2-5b: JWKS 검증 --- 공개키로 ID Token의 서명을 확인하고 사용자 정보를 추출한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/terminal/06_oidc-jwt-verification.png", alt: [OIDC 로그인 성공 응답 -- ID Token 검증 후 사용자 정보와 우리 서비스 JWT가 반환된다. Authorization 헤더에 Bearer {JWT}가 들어 있으면 성공이다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/01_architecture-overview.png", alt: [전체 아키텍처 -- 클라이언트 요청은 Nginx를 거쳐 서버 A 또는 B로 전달되고 세션은 Redis에 저장된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/02_server-ab-role.png", alt: [서버 A, B 역할 -- 두 서버는 동일한 애플리케이션이며 Redis를 통해 세션을 공유한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/04_session-share-code.png", alt: [세션 공유 코드 흐름 -- application.properties 설정만으로 세션 저장소가 Redis로 전환된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/03_nginx-routing.png", alt: [Nginx 라우팅 -- `/app1` 경로는 서버 A로, `/app2` 경로는 서버 B로 전달된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/05_docker-compose-structure.png", alt: [docker-compose 구성 -- Nginx, Spring A, Spring B, Redis 4개 컨테이너가 하나의 네트워크에서 동작한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/06_app1-count1.png", alt: [/app1 접속 -- App1-Server에서 응답하고 count가 1이다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/07_app2-count2.png", alt: [/app2 접속 -- App2-Server에서 응답하지만 count가 2로 이어진다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/08_app1-count3.png", alt: [다시 /app1 접속 -- count가 3으로 이어진다. 서버가 바뀌어도 세션이 유지된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/09_session-share-summary.png", alt: [Redis 세션 공유 정리 -- 서버가 여러 대여도 세션을 외부 저장소에 두면 로그인이 유지된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/diagram/04_upload-flow.png", alt: [Base64 이미지 업로드 흐름], max-width: 0.6)

=== 4.3 전체 흐름 한눈에 보기

이미지 업로드의 전체 흐름입니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/12_upload-flow-diagram.png", alt: [업로드 전체 흐름 -- Postman이 Base64 문자열을 보내면 Spring이 파일로 복원하고 DB에 기록한 뒤 URL을 반환한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/14_entity-design.png", alt: [ImageEntity 구조 -- id, uuid, fileName, url, createdAt 5개 필드로 구성된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/15_dto-design.png", alt: [DTO 설계 -- 요청은 파일명과 Base64 문자열을 받고 응답은 저장된 이미지 정보를 반환한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/16_upload-api-flow.png", alt: [업로드 API 흐름 -- Base64 디코딩, UUID 생성, 파일 저장, DB 기록 순서로 진행된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/02_base64-encode-site.png", alt: [Base64 인코딩 -- 온라인 변환 사이트에서 이미지를 업로드하면 Base64 문자열이 생성된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/03_base64-encode-upload.png", alt: [인코딩 결과 -- 이미지가 긴 텍스트 문자열로 변환된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/04_base64-encode-result.png", alt: [문자열 복사 -- 이 문자열을 Postman의 JSON body에 붙여넣는다], max-width: 0.6)

#v(paragraph-gap)
변환된 문자열을 Postman에서 JSON에 담아 보냅니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/05_postman-upload-request.png", alt: [Postman 업로드 요청 -- fileName과 fileData를 JSON으로 전송한다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/06_postman-upload-send.png", alt: [요청 Body -- fileData에 Base64 문자열이 담겨 있다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/07_postman-upload-response.png", alt: [업로드 응답 -- id, uuid, fileName, url, createdAt이 반환된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/08_browser-image-check.png", alt: [브라우저 확인 -- 반환된 URL로 접속하면 업로드한 이미지가 표시된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/17_static-resource-mapping.png", alt: [정적 리소스 매핑 -- `/uploads/**` 요청이 서버의 uploads 폴더로 연결된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/09_postman-get-by-id.png", alt: [단건 조회 -- id로 특정 이미지 정보를 조회한다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/10_postman-get-list.png", alt: [목록 조회 -- 저장된 모든 이미지 목록이 반환된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/11_browser-image-view.png", alt: [브라우저 이미지 확인 -- 정적 리소스 매핑을 통해 이미지가 브라우저에 표시된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/18_browser-static-image.png", alt: [정적 리소스 확인 -- 서버의 uploads 폴더에 저장된 파일이 브라우저에서 직접 접근 가능하다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/19_react-upload.png", alt: [React 이미지 업로드 -- 파일을 선택하면 Base64로 변환되어 서버에 전송된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/20_react-list.png", alt: [React 이미지 목록 -- 서버에 저장된 이미지들이 리스트로 표시된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/21_react-detail.png", alt: [React 이미지 상세 -- 개별 이미지의 정보와 원본 이미지가 표시된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/diagram/05_exercise-flow.png", alt: [이번 챕터의 실습 흐름], max-width: 0.6)

=== 5.3 아키텍처 구조

전체 흐름은 5단계입니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/gemini/05_upload-flow.png", alt: [업로드 단계 -- 서버는 URL만 발급하고 파일은 클라이언트가 S3에 직접 올린다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/gemini/05_resize-flow.png", alt: [후처리 단계 -- Lambda가 자동으로 리사이즈하고 Spring은 결과만 기록한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/07_env-file.png", alt: [환경 변수 설정 -- AWS 키를 환경 변수로 관리하면 코드에 노출되지 않는다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/08_postman-presign-request.png", alt: [Presigned URL 요청 -- fileName과 contentType을 JSON으로 보낸다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/09_postman-presign-response.png", alt: [Presigned URL 응답 -- presignedUrl과 key가 반환된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/10_postman-s3-put-header.png", alt: [S3 PUT 헤더 -- Content-Type을 presigned 요청과 동일하게 맞춘다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/11_postman-s3-put-binary.png", alt: [S3 PUT Body -- Binary 탭에서 이미지 파일을 직접 선택한다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/12_postman-s3-put-response.png", alt: [S3 업로드 성공 -- 200 OK가 반환되면 S3에 파일이 올라간 것이다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/13_s3-original-confirm.png", alt: [S3 확인 -- original 폴더에 업로드한 이미지가 저장되어 있다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/14_s3-original-image.png", alt: [원본 이미지 확인 -- S3에 저장된 이미지를 미리보기로 확인할 수 있다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/15_lambda-code-deploy.png", alt: [Lambda 배포 -- 코드를 작성하고 Deploy 버튼으로 배포한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/20_s3-resized-confirm.png", alt: [리사이즈 확인 -- resized 폴더에 축소된 이미지가 자동으로 생성되었다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/21_postman-complete-request.png", alt: [\/complete 요청 -- originalKey를 JSON으로 보낸다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/22_postman-complete-response.png", alt: [\/complete 응답 -- originalUrl과 resizedUrl이 모두 저장되어 반환된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/23_h2-console-confirm.png", alt: [DB 확인 -- H2 콘솔에서 원본 URL과 리사이즈 URL이 저장된 것을 확인한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/24_postman-list-response.png", alt: [목록 조회 -- 저장된 모든 이미지의 원본 URL과 리사이즈 URL이 반환된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/25_postman-detail-response.png", alt: [상세 조회 -- 특정 이미지의 전체 정보가 반환된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/diagram/06_exercise-flow.png", alt: [이번 챕터의 실습 흐름], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/gemini/06_communication-compare.png", alt: [세 방식의 통신 방향 비교], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/01_polling-devtools.png", alt: [Polling DevTools -- 2초마다 /chats 요청이 반복된다. 새 메시지가 없어도 요청은 계속 나간다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/02_sse-connect.png", alt: [SSE 연결 -- /chats/connect 요청이 한 번만 나가고 연결이 유지된다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/03_sse-connected-event.png", alt: [connect 이벤트 -- 연결 즉시 서버가 "connected" 메시지를 보내온다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/04_sse-chat-event.png", alt: [chat 이벤트 -- 다른 사용자가 채팅을 보내면 서버가 자동으로 밀어준다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/05_sse-realtime-ui.png", alt: [실시간 동기화 -- 두 브라우저에서 새로고침 없이 채팅이 바로 표시된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/06_ws-devtools.png", alt: [WebSocket 연결 -- /ws 엔드포인트로 한 번 연결되면 끊기지 않는다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/07_ws-subscribe.png", alt: [STOMP 구독 -- /topic/chats를 구독하면 서버가 보내는 메시지를 받을 준비가 된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/08_ws-send-receive.png", alt: [양방향 통신 -- 클라이언트가 보낸 메시지가 구독자 전원에게 전달된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/diagram/07_exercise-flow.png", alt: [이번 챕터의 실습 흐름], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/gemini/07_hls-flow.png", alt: [업로드부터 브라우저 재생까지의 HLS 흐름], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/01_postman-upload.png", alt: [영상 업로드 -- Postman으로 파일을 보내면 HLS 변환이 시작된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/02_hls-files-generated.png", alt: [HLS 파일 생성 -- m3u8 목록 파일과 ts 조각 파일이 만들어졌다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/03_postman-m3u8-check.png", alt: [m3u8 엔드포인트 확인 -- 재생 목록이 정상적으로 반환된다], max-width: 0.6)

#v(paragraph-gap)
720p와 1080p의 m3u8 응답입니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/04_m3u8-720p-response.png", alt: [720p m3u8 응답 -- ts 조각 파일 목록과 재생 시간이 기록되어 있다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/05_m3u8-1080p-response.png", alt: [1080p m3u8 응답 -- 같은 구조지만 해상도가 다르다], max-width: 0.6)

#v(paragraph-gap)
브라우저에서 실제로 재생하면서 DevTools Network 탭을 열어 봅니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/06_browser-player-devtools.png", alt: [브라우저 재생 -- ts 조각이 순차적으로 요청되며 영상이 끊기지 않고 재생된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/diagram/08_exercise-flow.png", alt: [이번 챕터의 실습 흐름], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/gemini/08_inverted-index.png", alt: [역인덱스 구조 -- 단어 목록에서 해당 문서를 바로 찾는다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/01_docker-compose-up.png", alt: [docker-compose up -- Elasticsearch, Kibana, Spring Boot 앱이 함께 올라간다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/02_es-health-check.png", alt: [localhost:9200 응답 -- cluster\_name, version 정보가 보이면 Elasticsearch가 정상 동작하고 있다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/03_postman-bulk-save.png", alt: [Postman으로 데이터 저장 -- 요청이 성공하면 저장된 Document가 응답으로 온다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/04_h2-data-confirm.png", alt: [H2 콘솔 확인 -- RDB에도 같은 데이터가 들어가 있다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/11_postman-normal-search.png", alt: [Postman 검색 -- "갤럭시"로 검색하면 관련 데이터가 반환된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/05_kibana-home.png", alt: [Kibana 메인 화면 -- 왼쪽 메뉴에서 Dev Tools를 찾는다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/06_kibana-devtools-open.png", alt: [Dev Tools 진입 -- 검색 쿼리를 직접 실행할 수 있는 콘솔이 열린다], max-width: 0.6)

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/07_kibana-devtools-console.png", alt: [Dev Tools 콘솔 -- 왼쪽에 쿼리를 작성하고 오른쪽에서 결과를 확인한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/10_kibana-fuzzy-search.png", alt: [Kibana Fuzzy 검색 -- "갈럭시"로 검색해도 "갤럭시" 문서가 나온다], max-width: 0.6)

#v(paragraph-gap)
Kibana에서 직접 문서를 삽입할 수도 있습니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/08_kibana-insert-doc.png", alt: [Kibana에서 문서 직접 삽입 -- PUT 요청으로 ES에 문서를 넣을 수 있다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/09_h2-no-kibana-insert.png", alt: [H2 확인 -- Kibana에서 넣은 데이터는 RDB에 없다], max-width: 0.6)

#v(paragraph-gap)
Postman에서 오타 검색도 확인합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/12_postman-fuzzy-search.png", alt: [Postman Fuzzy 검색 -- 앱을 통한 오타 검색도 정상 동작한다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/diagram/09_exercise-flow.png", alt: [이번 챕터의 실습 흐름], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/gemini/09_rabbitmq-flow.png", alt: [전체 흐름 -- GitHub 변경이 Producer를 거쳐 RabbitMQ를 통해 Consumer에 전달된다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/03_rabbitmq-login.png", alt: [RabbitMQ 관리 콘솔 로그인 화면 -- guest/guest로 접속한다], max-width: 0.6)

#v(paragraph-gap)
로그인하면 관리 콘솔 메인 화면이 나옵니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/01_rabbitmq-management-ui.png", alt: [RabbitMQ 관리 콘솔 -- 연결, 채널, Exchange, Queue 상태를 한눈에 볼 수 있다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/02_github-config-readme-repo.png", alt: [GitHub에 config-readme 레포 생성 -- 이 레포의 README 변경을 감지할 것이다], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/06_producer-bootrun.png", alt: [Producer 서버 실행 -- 60초마다 GitHub을 폴링한다], max-width: 0.6)

#v(paragraph-gap)
GitHub에서 README를 수정하고 커밋합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/07_github-readme-edit.png", alt: [GitHub에서 README 수정], max-width: 0.6)

#v(paragraph-gap)
Producer 로그에서 변경 감지를 확인합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/08_producer-detect-log.png", alt: [Producer가 SHA 변경을 감지하고 메시지를 발행한 로그], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/13_all-servers-running.png", alt: [Docker, Producer, Consumer 세 서버가 모두 실행 중이다], max-width: 0.6)

#v(paragraph-gap)
RabbitMQ 관리 콘솔에서 Exchange 탭을 확인합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/04_exchanges-tab.png", alt: [Exchanges 탭 -- Producer가 등록한 github.events Exchange가 보인다], max-width: 0.6)

#v(paragraph-gap)
Exchange 상세에서 Binding 정보를 확인합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/09_exchange-detail.png", alt: [Exchange 상세 -- repo-updates Queue에 readme.changed Routing Key로 바인딩되어 있다], max-width: 0.6)

#v(paragraph-gap)
Queue 상세에서 메시지 수와 상태를 확인합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/10_queue-detail.png", alt: [Queue 상세 -- repo-updates Queue의 메시지 수와 소비 상태가 보인다], max-width: 0.6)

#v(paragraph-gap)
Binding 정보도 확인합니다. Exchange에서 Queue로의 연결 규칙입니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/11_binding-detail.png", alt: [Binding 확인 -- readme.changed Routing Key로 바인딩되어 있다], max-width: 0.6)

#v(paragraph-gap)
이제 GitHub에서 README를 수정하고 커밋합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/14_github-readme-commit.png", alt: [GitHub에서 README를 수정하고 커밋한다], max-width: 0.6)

#v(paragraph-gap)
Producer가 변경을 감지합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/15_producer-polling-log.png", alt: [Producer가 SHA 변경을 감지하고 메시지를 발행한다], max-width: 0.6)

#v(paragraph-gap)
Consumer가 메시지를 수신합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/16_consumer-receive-log.png", alt: [Consumer가 메시지를 수신하고 파일 반영을 시작한다], max-width: 0.6)

#v(paragraph-gap)
로컬 README 파일이 자동으로 업데이트됩니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/17_consumer-readme-updated.png", alt: [로컬 README 파일이 GitHub의 내용으로 자동 업데이트되었다], max-width: 0.6)

#v(paragraph-gap)
백업 파일도 생성되었는지 확인합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/18_backup-file-confirm.png", alt: [이전 내용이 백업 파일로 저장되어 있다], max-width: 0.6)

#v(paragraph-gap)
관리 콘솔에서 Queue에 들어온 메시지 내용을 직접 확인할 수도 있습니다. Queue 상세 화면에서 Get Messages를 클릭합니다.

#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/12_get-messages-payload.png", alt: [Queue 메시지 payload -- repo, sha, content, timestamp가 JSON으로 들어 있다], max-width: 0.6)
