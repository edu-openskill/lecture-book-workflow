...
<svg viewBox="0 0 1000 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="메시지 큐 개념: Producer가 Topic에 메시지를 쌓고 Consumer가 차례로 읽음">
  ...
  <rect x="320" y="70" width="360" height="120" rx="10" fill="#fff4ed" stroke="#ff7849" stroke-width="1.8"/>
  <text x="500" y="100" text-anchor="middle" font-size="11" font-weight="700" fill="#7b341e">TOPIC</text>
  <text x="500" y="126" text-anchor="middle" font-size="15" font-weight="700" fill="#7b341e" font-family="JetBrains Mono, monospace">order-created</text>
  <rect x="345" y="146" width="58" height="30" rx="4" fill="#fff" stroke="#ff7849"/>
  <text x="374" y="166" text-anchor="middle" font-size="11" fill="#7b341e" font-family="JetBrains Mono, monospace">msg1</text>
  <rect x="408" y="146" width="58" height="30" rx="4" fill="#fff" stroke="#ff7849"/>
  <text x="437" y="166" text-anchor="middle" font-size="11" fill="#7b341e" font-family="JetBrains Mono, monospace">msg2</text>
  <rect x="471" y="146" width="58" height="30" rx="4" fill="#fff" stroke="#ff7849"/>
  <text x="500" y="166" text-anchor="middle" font-size="11" fill="#7b341e" font-family="JetBrains Mono, monospace">msg3</text>
  <rect x="534" y="146" width="58" height="30" rx="4" fill="#fff" stroke="#ff7849"/>
  <text x="563" y="166" text-anchor="middle" font-size="11" fill="#7b341e" font-family="JetBrains Mono, monospace">msg4</text>
  <text x="625" y="165" text-anchor="middle" font-size="14" fill="#9a3412">…</text>
