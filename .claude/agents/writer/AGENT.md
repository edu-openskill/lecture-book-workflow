...
### 톤
 - 서술어 통일: 독자와 대화하는 듯한 부드러운 **구어체 대화형(해요체/하십시오체 혼용)** 문체 사용
 - 멘토링 스타일: 독자에게 권장, 안내, 질문하는 어조("~해볼까요?", "~해 보시길 권장합니다", "~죠")를 적절히 섞어 친절하게 설명
 - 예외: 캐릭터 직접 대화(" ")와 내면 독백(*이탤릭*)에도 구어체를 적극 활용해 생동감 있게 표현
